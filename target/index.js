...
var _darrensiegel$elm_chess_client$Data_Type$Piece = F6(
	function (a, b, c, d, e, f) {
		return {position: a, location: b, color: c, role: d, tick: e, path: f};
	});
var _darrensiegel$elm_chess_client$Data_Type$Square = F4(
	function (a, b, c, d) {
		return {location: a, piece: b, valid: c, active: d};
	});
var _darrensiegel$elm_chess_client$Data_Type$Selection = F4(
	function (a, b, c, d) {
		return {board: a, player: b, square: c, piece: d};
	});
...
var _darrensiegel$elm_chess_client$Data_Tool$nullPlayer = _darrensiegel$elm_chess_client$Data_Tool$idlePlayer(_darrensiegel$elm_chess_client$Data_Type$White);
...
var _darrensiegel$elm_chess_client$Data_Tool$toPosition = function (_p0) {
	var _p1 = _p0;
	return {x: _p1._1, y: _p1._0};
};
var _darrensiegel$elm_chess_client$Data_Tool$toLocations = _elm_lang$core$List$map(
	_elm_lang$core$Basics$uncurry(_chendrix$elm_matrix$Matrix$loc));
var _darrensiegel$elm_chess_client$Data_Tool$toLocation = function (p) {
	return A2(_chendrix$elm_matrix$Matrix$loc, p.y, p.x);
};
var _darrensiegel$elm_chess_client$Data_Tool$pos = F2(
	function (x_, y_) {
		return {x: x_, y: y_};
	});
var _darrensiegel$elm_chess_client$Data_Tool$isPositive = function (n) {
	return !_elm_lang$core$Native_Utils.eq(
		_elm_lang$core$Basics$negate(
			_elm_lang$core$Basics$abs(n)),
		n);
};
var _darrensiegel$elm_chess_client$Data_Tool$mapBoth = F2(
	function (fn, tup) {
		return A2(
...
var _darrensiegel$elm_chess_client$Data_Tool$foldl1 = F2(
	function (f, xs) {
		var mf = F2(
			function (x, m) {
				return _elm_lang$core$Maybe$Just(
					function () {
						...
						if (_p2.ctor === 'Nothing') {
							...
							return A2(f, _p2._0, x);
						}
					}());
			});
		return A3(_elm_lang$core$List$foldl, mf, _elm_lang$core$Maybe$Nothing, xs);
	});
var _darrensiegel$elm_chess_client$Data_Tool$last = _darrensiegel$elm_chess_client$Data_Tool$foldl1(
	_elm_lang$core$Basics$flip(_elm_lang$core$Basics$always));
var _darrensiegel$elm_chess_client$Data_Tool$swap = function (_p3) {
	var _p4 = _p3;
	return {ctor: '_Tuple2', _0: _p4._1, _1: _p4._0};
};
var _darrensiegel$elm_chess_client$Data_Tool$snd = _elm_lang$core$Tuple$second;
var _darrensiegel$elm_chess_client$Data_Tool$fst = _elm_lang$core$Tuple$first;
var _darrensiegel$elm_chess_client$Data_Tool$tupleToList = function (t) {
	return {
		ctor: '::',
		_0: _darrensiegel$elm_chess_client$Data_Tool$fst(t),
		_1: {
			ctor: '::',
			_0: _darrensiegel$elm_chess_client$Data_Tool$snd(t),
			_1: {ctor: '[]'}
		}
	};
};
var _darrensiegel$elm_chess_client$Data_Tool_ops = _darrensiegel$elm_chess_client$Data_Tool_ops || {};
_darrensiegel$elm_chess_client$Data_Tool_ops['??'] = F2(
	function (a, b) {
		return a ? b : {ctor: '[]'};
	});
var _darrensiegel$elm_chess_client$Data_Tool_ops = _darrensiegel$elm_chess_client$Data_Tool_ops || {};
...
var _darrensiegel$elm_chess_client$Data_Tool$liftAp = F3(
	function (fn, l1, l2) {
		return A2(
			_darrensiegel$elm_chess_client$Data_Tool_ops['$$>'],
			A2(_darrensiegel$elm_chess_client$Data_Tool_ops['$>>'], fn, l1),
			l2);
	});
var _darrensiegel$elm_chess_client$Data_Tool$squareSize = 54;
var _darrensiegel$elm_chess_client$Data_Tool$fromMousePosition = function (position) {
	var y = ((position.y - 56) / _darrensiegel$elm_chess_client$Data_Tool$squareSize) | 0;
	var x = (position.x / _darrensiegel$elm_chess_client$Data_Tool$squareSize) | 0;
	return A2(_elm_lang$mouse$Mouse$Position, x, y);
};
var _darrensiegel$elm_chess_client$Data_Tool$toBoardLocation = function (ps) {
	return _darrensiegel$elm_chess_client$Data_Tool$toLocation(
		_darrensiegel$elm_chess_client$Data_Tool$fromMousePosition(ps));
};
var _darrensiegel$elm_chess_client$Data_Tool$toBoardPosition = function (location) {
	var p = _darrensiegel$elm_chess_client$Data_Tool$toPosition(location);
	var x = p.x * _darrensiegel$elm_chess_client$Data_Tool$squareSize;
	var y = p.y * _darrensiegel$elm_chess_client$Data_Tool$squareSize;
	return A2(_elm_lang$mouse$Mouse$Position, x, y);
};
...
var _darrensiegel$elm_chess_client$Model_FEN$toSquare = F2(
	function (lc, ch) {
		var occupied = A4(
			...
			lc,
			_elm_lang$core$Maybe$Just(
				A2(_darrensiegel$elm_chess_client$Model_FEN$toPiece, ch, lc)),
			false,
			false);
...
var _darrensiegel$elm_chess_client$Model_FEN$expandMatch = function (_p2) {
	...
	return A2(
		...
		A2(
			...
			0,
			_elm_lang$core$String$toInt(_p3.match)),
		' ');
};
var _darrensiegel$elm_chess_client$Model_FEN$expand = function (s) {
	return A4(
...
var _darrensiegel$elm_chess_client$Model_FEN$toRank = F2(
	function (y, row) {
		var points = A2(
			...
			A2(
				_elm_lang$core$List$map,
				_darrensiegel$elm_chess_client$Data_Tool$swap,
				A3(
					_elm_lang$core$List$map2,
					F2(
						function (v0, v1) {
		...
		var pieces = _elm_lang$core$String$toList(
			_darrensiegel$elm_chess_client$Model_FEN$expand(row));
		return A3(_elm_lang$core$List$map2, _darrensiegel$elm_chess_client$Model_FEN$toSquare, points, pieces);
	});
var _darrensiegel$elm_chess_client$Model_FEN$parsePieces = function (s) {
...
var _darrensiegel$elm_chess_client$Model_FEN$initialPieces = 'rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR';
var _darrensiegel$elm_chess_client$Model_FEN$initialBoard = A2(_elm_lang$core$Basics_ops['++'], _darrensiegel$elm_chess_client$Model_FEN$initialPieces, ' w KQkq - 0 1');
var _darrensiegel$elm_chess_client$Model_FEN$fromFEN = function (fen) {
	...
	var board = _darrensiegel$elm_chess_client$Model_FEN$parsePieces(
		A2(
			_elm_lang$core$Maybe$withDefault,
			_darrensiegel$elm_chess_client$Model_FEN$initialPieces,
...
var _darrensiegel$elm_chess_client$Data_Query$isCastling = function (piece) {
	var castlesLocations = _darrensiegel$elm_chess_client$Data_Tool$toLocations(
		{
			ctor: '::',
...
var _darrensiegel$elm_chess_client$Data_Query$startingRank = function (piece) {
	var offset = function (n) {
		var _p11 = piece.color;
		if (_p11.ctor === 'White') {
			return 7 - n;
		} else {
			return n;
...
var _darrensiegel$elm_chess_client$Data_Query$starting = function (piece) {
	var _p13 = piece.location;
	var y = _p13._0;
	var x = _p13._1;
	return _elm_lang$core$Native_Utils.eq(
		_darrensiegel$elm_chess_client$Data_Query$startingRank(piece),
		y);
};
...
var _darrensiegel$elm_chess_client$Model_Moves$left = F2(
	function (n, _p2) {
		var _p3 = _p2;
		return A2(_chendrix$elm_matrix$Matrix$loc, _p3._0, _p3._1 - n);
	});
var _darrensiegel$elm_chess_client$Model_Moves$down = F2(
	function (n, _p4) {
		var _p5 = _p4;
		return A2(_chendrix$elm_matrix$Matrix$loc, _p5._0 + n, _p5._1);
	});
var _darrensiegel$elm_chess_client$Model_Moves$up = F2(
	function (n, _p6) {
		var _p7 = _p6;
		return A2(_chendrix$elm_matrix$Matrix$loc, _p7._0 - n, _p7._1);
	});
var _darrensiegel$elm_chess_client$Model_Moves$cardinals = {
	ctor: '_Tuple2',
	_0: {
		ctor: '::',
		_0: _darrensiegel$elm_chess_client$Model_Moves$up,
		_1: {
			ctor: '::',
			_0: _darrensiegel$elm_chess_client$Model_Moves$down,
			_1: {ctor: '[]'}
		}
	},
	_1: {
		ctor: '::',
		_0: _darrensiegel$elm_chess_client$Model_Moves$left,
		_1: {
			ctor: '::',
			_0: _darrensiegel$elm_chess_client$Model_Moves$right,
			_1: {ctor: '[]'}
		}
	}
};
var _darrensiegel$elm_chess_client$Model_Moves$asterisk = function () {
	var combinatorial = function (_p8) {
		return _elm_lang$core$Basics$uncurry(
			_darrensiegel$elm_chess_client$Data_Tool$liftAp(
				F2(
					function (x, y) {
						return A2(_elm_lang$core$Basics_ops['++'], x, y);
					})))(
			A2(
				_darrensiegel$elm_chess_client$Data_Tool$mapBoth,
				F2(
					function (x, y) {
						return A2(_darrensiegel$elm_chess_client$Data_Tool_ops['$>>'], x, y);
					})(_elm_lang$core$List$singleton),
				_p8));
	};
	return combinatorial(_darrensiegel$elm_chess_client$Model_Moves$cardinals);
}();
var _darrensiegel$elm_chess_client$Model_Moves$cross = function () {
	var wrap = function (_p9) {
		return A2(
			F2(
				function (x, y) {
					return A2(_darrensiegel$elm_chess_client$Data_Tool_ops['$>>'], x, y);
			...
			_elm_lang$core$List$singleton,
			_elm_lang$core$List$concat(
				_darrensiegel$elm_chess_client$Data_Tool$tupleToList(_p9)));
	};
	return wrap(_darrensiegel$elm_chess_client$Model_Moves$cardinals);
}();
var _darrensiegel$elm_chess_client$Model_Moves$forward = function (piece) {
	var _p10 = piece.color;
	if (_p10.ctor === 'White') {
		return _darrensiegel$elm_chess_client$Model_Moves$up;
	} else {
		return _darrensiegel$elm_chess_client$Model_Moves$down;
	}
};
var _darrensiegel$elm_chess_client$Model_Moves$backward = function (piece) {
	var _p11 = piece.color;
	if (_p11.ctor === 'White') {
		return _darrensiegel$elm_chess_client$Model_Moves$down;
	} else {
...
var _darrensiegel$elm_chess_client$Model_Moves$stay = function (l) {
	return l;
};
var _darrensiegel$elm_chess_client$Model_Moves$stepSearch = F3(
	function (board, piece, directions) {
		var stepRange = A2(
			_elm_lang$core$List$map,
			F2(
				function (x, y) {
			...
			function (ways, depth, _p12) {
				...
				if (_p15) {
					var tracePath = _elm_lang$core$Native_Utils.eq(
						...
						_elm_lang$core$Basics$always(_darrensiegel$elm_chess_client$Model_Moves$stay))(depth) : A2(
						_elm_community$maybe_extra$Maybe_Extra_ops['?'],
						A2(
							_darrensiegel$elm_chess_client$Data_Tool$foldl1,
							F2(
								function (x, y) {
									return function (_p14) {
										return y(
							...
							A2(
								...
								ways)),
						_darrensiegel$elm_chess_client$Model_Moves$stay);
					var target = A2(
						_elm_community$maybe_extra$Maybe_Extra_ops['?'],
						A2(
					...
					return _darrensiegel$elm_chess_client$Data_Query$isVacant(target) ? {
						ctor: '_Tuple2',
						_0: _p15,
						_1: {ctor: '::', _0: tracePath, _1: _p16}
					} : ((!A2(_darrensiegel$elm_chess_client$Data_Query$friendlyOccupied, piece.color, target)) ? {
						ctor: '_Tuple2',
						_0: stop,
						_1: {ctor: '::', _0: tracePath, _1: _p16}
		...
		var _p19 = A3(_elm_lang$core$List$foldl, search, accum, directions);
		var paths = _p19._1;
		return paths;
	});

var _darrensiegel$elm_chess_client$Model_Rules$distinct = F3(
	function (board, piece, locations) {
		return A2(
			_elm_lang$core$List$filterMap,
			function (move) {
				var _p0 = A2(
					...
					board);
				if (_p0.ctor === 'Just') {
					var _p1 = _p0._0.piece;
					if (_p1.ctor === 'Just') {
						return _elm_lang$core$Native_Utils.eq(_p1._0.color, piece.color) ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(move);
					} else {
...
var _darrensiegel$elm_chess_client$Model_Rules$validate = F4(
	function (board, piece, _p2, moves) {
		var _p3 = _p2;
		var _p4 = _p3._0;
		var target = A2(
			_chendrix$elm_matrix$Matrix$get,
		...
		return A2(
			...
			A2(
				_darrensiegel$elm_chess_client$Data_Tool_ops['<?'],
				function (square) {
					return _p3._1(square) ? {ctor: '::', _0: _p4, _1: moves} : moves;
				},
				target),
			moves);
	});
	...
	function (board, king) {
		...
		var castling = function (step) {
			...
			return A2(
				...
				A2(_elm_lang$core$List$map, _darrensiegel$elm_chess_client$Data_Tool$fst, castlepath));
		};
		var sides = {
			ctor: '::',
			_0: _darrensiegel$elm_chess_client$Model_Moves$right,
...
var _darrensiegel$elm_chess_client$Model_Rules$enPassant = F2(
	function (board, pawn) {
		...
		var checkPawn = A2(
			_elm_lang$core$List$foldl,
			A2(_darrensiegel$elm_chess_client$Model_Rules$validate, board, pawn),
			{ctor: '[]'});
		var passing = F2(
			function (dir, square) {
		...
		var step = _darrensiegel$elm_chess_client$Model_Moves$forward(pawn);
		var rules = {
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: function (_p6) {
					return A2(
						_darrensiegel$elm_chess_client$Model_Moves$left,
						1,
						A2(step, 1, _p6));
				},
				_1: passing(_darrensiegel$elm_chess_client$Model_Moves$left)
			},
			_1: {
				ctor: '::',
				_0: {
					...
					_0: function (_p7) {
						return A2(
							_darrensiegel$elm_chess_client$Model_Moves$right,
							1,
							A2(step, 1, _p7));
					},
					_1: passing(_darrensiegel$elm_chess_client$Model_Moves$right)
				},
				_1: {ctor: '[]'}
			}
		};
...
var _darrensiegel$elm_chess_client$Model_Rules$pawnMoves = F2(
	function (board, pawn) {
		...
		var rules = A2(
			_elm_lang$core$Basics_ops['++'],
			_darrensiegel$elm_chess_client$Data_Query$starting(pawn) ? {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: step(2),
...
var _darrensiegel$elm_chess_client$Model_Rules$isEnPassant = F2(
	function (board, piece) {
		return _darrensiegel$elm_chess_client$Data_Query$passanting(piece) && function (_p11) {
			return _elm_community$maybe_extra$Maybe_Extra$isJust(
				_elm_lang$core$List$head(_p11));
		}(
			A2(_darrensiegel$elm_chess_client$Model_Rules$enPassant, board, piece));
	});
var _darrensiegel$elm_chess_client$Model_Rules$pieceMoves = F2(
	function (piece, board) {
		var cast = function (fn) {
			return A2(fn, board, piece);
		};
		var diagonals = A2(cast, _darrensiegel$elm_chess_client$Model_Moves$stepSearch, _darrensiegel$elm_chess_client$Model_Moves$asterisk);
		var parallels = A2(cast, _darrensiegel$elm_chess_client$Model_Moves$stepSearch, _darrensiegel$elm_chess_client$Model_Moves$cross);
		var moves = function (role) {
			var _p12 = role;
			switch (_p12.ctor) {
				case 'Pawn':
					return cast(_darrensiegel$elm_chess_client$Model_Rules$pawnMoves);
				case 'Bishop':
					return diagonals;
				case 'Rook':
					return parallels;
					...
					return {
						...
						_0: function (_p13) {
							return A2(
								_darrensiegel$elm_chess_client$Model_Moves$right,
								1,
								A2(_darrensiegel$elm_chess_client$Model_Moves$up, 2, _p13));
						},
						_1: {
							ctor: '::',
							_0: function (_p14) {
								return A2(
									_darrensiegel$elm_chess_client$Model_Moves$left,
									1,
									A2(_darrensiegel$elm_chess_client$Model_Moves$up, 2, _p14));
							},
							_1: {
								ctor: '::',
								_0: function (_p15) {
									return A2(
										_darrensiegel$elm_chess_client$Model_Moves$left,
										1,
										A2(_darrensiegel$elm_chess_client$Model_Moves$down, 2, _p15));
								},
								_1: {
									ctor: '::',
									_0: function (_p16) {
										return A2(
											_darrensiegel$elm_chess_client$Model_Moves$right,
											1,
											A2(_darrensiegel$elm_chess_client$Model_Moves$down, 2, _p16));
									},
									_1: {
										ctor: '::',
										_0: function (_p17) {
											return A2(
												_darrensiegel$elm_chess_client$Model_Moves$up,
												1,
												A2(_darrensiegel$elm_chess_client$Model_Moves$left, 2, _p17));
										},
										_1: {
											ctor: '::',
											_0: function (_p18) {
												return A2(
													_darrensiegel$elm_chess_client$Model_Moves$down,
													1,
													A2(_darrensiegel$elm_chess_client$Model_Moves$left, 2, _p18));
											},
											_1: {
												ctor: '::',
												_0: function (_p19) {
													return A2(
														_darrensiegel$elm_chess_client$Model_Moves$up,
														1,
														A2(_darrensiegel$elm_chess_client$Model_Moves$right, 2, _p19));
												},
												_1: {
													ctor: '::',
													_0: function (_p20) {
														return A2(
															_darrensiegel$elm_chess_client$Model_Moves$down,
															1,
															A2(_darrensiegel$elm_chess_client$Model_Moves$right, 2, _p20));
													},
													_1: {ctor: '[]'}
												}
											}
				...
				case 'King':
					return A2(
						...
						{
							ctor: '::',
							_0: _darrensiegel$elm_chess_client$Model_Moves$up(1),
							_1: {
								ctor: '::',
								_0: _darrensiegel$elm_chess_client$Model_Moves$down(1),
								_1: {
									ctor: '::',
									_0: _darrensiegel$elm_chess_client$Model_Moves$left(1),
									_1: {
										ctor: '::',
										_0: _darrensiegel$elm_chess_client$Model_Moves$right(1),
										_1: {
											ctor: '::',
											_0: function (_p21) {
												return A2(
													_darrensiegel$elm_chess_client$Model_Moves$left,
													1,
													A2(_darrensiegel$elm_chess_client$Model_Moves$up, 1, _p21));
											},
											_1: {
												ctor: '::',
												_0: function (_p22) {
													return A2(
														_darrensiegel$elm_chess_client$Model_Moves$right,
														1,
														A2(_darrensiegel$elm_chess_client$Model_Moves$up, 1, _p22));
												},
												_1: {
													ctor: '::',
													_0: function (_p23) {
														return A2(
															_darrensiegel$elm_chess_client$Model_Moves$left,
															1,
															A2(_darrensiegel$elm_chess_client$Model_Moves$down, 1, _p23));
													},
													_1: {
														ctor: '::',
														_0: function (_p24) {
															return A2(
																_darrensiegel$elm_chess_client$Model_Moves$right,
																1,
																A2(_darrensiegel$elm_chess_client$Model_Moves$down, 1, _p24));
														},
														_1: {ctor: '[]'}
													}
												}
						...
						cast(_darrensiegel$elm_chess_client$Model_Rules$castle));
				default:
					return {ctor: '[]'};
			}
		};
...
var _darrensiegel$elm_chess_client$Model_Board$whenCastling = F3(
	function (fn, mv, bd) {
		return _darrensiegel$elm_chess_client$Data_Query$isCastling(mv.piece) ? A2(fn, mv, bd) : bd;
	});
...
var _darrensiegel$elm_chess_client$Model_Board$translatePiece = F2(
	function (target, piece) {
		...
		var lastPath = _darrensiegel$elm_chess_client$Data_Tool$last(piece.path);
		var destination = _darrensiegel$elm_chess_client$Data_Tool$toBoardPosition(target);
		return _elm_lang$core$Native_Utils.update(
			piece,
			{
...
var _darrensiegel$elm_chess_client$Model_Board$drop = function (_p4) {
	var _p5 = _p4;
	var _p6 = _p5.piece;
	var target = _p6.location;
	var newPiece = A2(_darrensiegel$elm_chess_client$Model_Board$translatePiece, target, _p6);
	return A3(
		_chendrix$elm_matrix$Matrix$update,
		target,
...
var _darrensiegel$elm_chess_client$Model_Board$jump = function (_p7) {
	var _p8 = _p7;
	var _p9 = _p8.piece;
	var target = _p9.location;
	var newPiece = A2(_darrensiegel$elm_chess_client$Model_Board$translatePiece, target, _p9);
	return A3(
		_chendrix$elm_matrix$Matrix$update,
		target,
		_darrensiegel$elm_chess_client$Model_Board$occupySquare(newPiece),
...
var _darrensiegel$elm_chess_client$Model_Board$revert = function (_p10) {
	var _p11 = _p10;
	var putback = function (target) {
		return _darrensiegel$elm_chess_client$Model_Board$withActiveSquare(
			_darrensiegel$elm_chess_client$Model_Board$occupySquare(
				A2(_darrensiegel$elm_chess_client$Model_Board$translatePiece, target, _p11.piece)));
	};
	return A2(_chendrix$elm_matrix$Matrix$mapWithLocation, putback, _p11.board);
};
...
var _darrensiegel$elm_chess_client$Model_Board$analyze = function (_p12) {
	var _p13 = _p12;
	var _p15 = _p13.piece;
	var _p14 = _p13.board;
	...
	var translations = A2(_darrensiegel$elm_chess_client$Model_Rules$pieceMoves, _p15, _p14);
	var origin = _p15.location;
	var movelist = A2(
		_elm_lang$core$List$map,
		A2(
			_elm_lang$core$Basics$flip,
	...
	return A3(_elm_lang$core$List$foldl, validateSquares, _p14, locations);
};
...
var _darrensiegel$elm_chess_client$Model_Board$remove = function (_p16) {
	var _p17 = _p16;
	var _p19 = _p17.piece;
	var lastLocation = A2(
		_elm_community$maybe_extra$Maybe_Extra_ops['?'],
		_darrensiegel$elm_chess_client$Data_Tool$last(_p19.path),
		_p19.location);
	return A3(
		_chendrix$elm_matrix$Matrix$update,
		lastLocation,
		function (_p18) {
			return _darrensiegel$elm_chess_client$Model_Board$activateSquare(
				_darrensiegel$elm_chess_client$Model_Board$emptySquare(_p18));
		},
		_p17.board);
};
var _darrensiegel$elm_chess_client$Model_Board$castleRook = F2(
	function (move, board) {
		...
		var rookMove = _darrensiegel$elm_chess_client$Data_Tool$isPositive(castleDiff) ? {
			ctor: '_Tuple2',
		...
		var rookSquare = A2(
			...
			A2(
				...
				board),
			_darrensiegel$elm_chess_client$Data_Tool$vacantSquare);
		var rook = A2(_elm_community$maybe_extra$Maybe_Extra_ops['?'], rookSquare.piece, _darrensiegel$elm_chess_client$Data_Tool$nullPiece);
		var rookSrc = A4(_darrensiegel$elm_chess_client$Data_Type$Selection, board, _darrensiegel$elm_chess_client$Data_Tool$nullPlayer, rookSquare, rook);
		var rookDest = _elm_lang$core$Native_Utils.update(
			rookSrc,
			{
				board: _darrensiegel$elm_chess_client$Model_Board$remove(rookSrc),
				piece: _elm_lang$core$Native_Utils.update(
					rook,
					{
						location: _darrensiegel$elm_chess_client$Data_Tool$snd(rookMove)
					})
			});
		return _darrensiegel$elm_chess_client$Model_Board$jump(rookDest);
	});
...
var _darrensiegel$elm_chess_client$Model_Board$place = function (selection) {
	return _darrensiegel$elm_chess_client$Model_Board$ticks(
		_darrensiegel$elm_chess_client$Model_Board$drop(selection));
};
var _darrensiegel$elm_chess_client$Model_Board$lift = function (_p22) {
	var _p23 = _p22;
	return _darrensiegel$elm_chess_client$Model_Board$remove(
		_elm_lang$core$Native_Utils.update(
			_p23,
			{
				board: _darrensiegel$elm_chess_client$Model_Board$clear(_p23.board)
			}));
};
...
var _darrensiegel$elm_chess_client$State_Action$endMove = F2(
	function (board, select) {
		var originPiece = function (s) {
			return _elm_lang$core$Native_Utils.update(
				s,
				{
					position: _darrensiegel$elm_chess_client$Data_Tool$toBoardPosition(select.square.location),
					location: select.square.location
				});
		}(select.piece);
		var isPassant = function () {
			var _p0 = originPiece.role;
			if (_p0.ctor === 'Pawn') {
				return A2(_darrensiegel$elm_chess_client$Model_Rules$isEnPassant, board, originPiece);
			} else {
				return false;
			}
		}();
		var destination = _darrensiegel$elm_chess_client$Data_Tool$toBoardLocation(select.piece.position);
		var target = A2(
			_elm_community$maybe_extra$Maybe_Extra_ops['?'],
		...
		var targetPiece = function () {
			if (isPassant) {
				var captureLocation = A3(_darrensiegel$elm_chess_client$Model_Moves$backward, originPiece, 1, destination);
		...
		return ((!_elm_lang$core$Native_Utils.eq(destination, select.square.location)) && target.valid) ? _darrensiegel$elm_chess_client$Data_Type$End(
			A5(_darrensiegel$elm_chess_client$Data_Type$Move, select.square.location, destination, movingPiece, targetPiece, isPassant)) : _darrensiegel$elm_chess_client$Data_Type$Playing(select);
	});
var _darrensiegel$elm_chess_client$State_Action$capturing = F2(
...
var _darrensiegel$elm_chess_client$State_Action$select = F3(
	function (board, player, position) {
		var selectPiece = function (square) {
			var selection = function (piece) {
				return A4(_darrensiegel$elm_chess_client$Data_Type$Selection, board, player, square, piece);
			};
		...
		var locate = function (xy) {
			return A2(
				_chendrix$elm_matrix$Matrix$get,
				_darrensiegel$elm_chess_client$Data_Tool$toBoardLocation(xy),
				board);
		};
...
var _darrensiegel$elm_chess_client$State_Game$update = F2(
	function (event, _p0) {
		var _p1 = _p0;
		var _p19 = _p1.ui;
		var _p18 = _p1.players;
		var _p17 = _p1.chess;
		var player = _darrensiegel$elm_chess_client$Data_Tool$fst(_p18);
		var selection = function () {
			var _p2 = event;
			if (_p2.ctor === 'Click') {
				return A3(_darrensiegel$elm_chess_client$State_Action$select, _p17.board, player, _p2._0);
			} else {
				return _elm_lang$core$Maybe$Nothing;
			}
		}();
		var action = function () {
			...
			switch (_p3.ctor) {
				case 'Click':
					var _p5 = _p3._0;
					var clickTo = A2(_darrensiegel$elm_chess_client$State_Action$clickMove, _p17.board, player);
					var target = _darrensiegel$elm_chess_client$Data_Tool$toBoardLocation(_p5);
					var _p4 = selection;
					if (_p4.ctor === 'Just') {
						return A2(_darrensiegel$elm_chess_client$State_Action$capturing, player, selection) ? A2(clickTo, _p5, target) : A2(_darrensiegel$elm_chess_client$State_Action$startMoving, _p5, _p4._0);
					} else {
				...
				case 'Drop':
					return A2(
						_darrensiegel$elm_chess_client$State_Action$whileMoving,
						player.action,
						_darrensiegel$elm_chess_client$State_Action$endMove(_p17.board));
				default:
					return _darrensiegel$elm_chess_client$Data_Type$Idle;
			}
		}();
		var history = function () {
			var _p6 = action;
			if (_p6.ctor === 'End') {
				return {ctor: '::', _0: _p6._0, _1: _p17.history};
			} else {
				return _p17.history;
			}
		}();
		...
		var players_ = function () {
			...
			if (_p7.ctor === 'End') {
				return {
					ctor: '_Tuple2',
					_0: _darrensiegel$elm_chess_client$Data_Tool$snd(_p18),
					_1: player_
				};
			} else {
				return {
					ctor: '_Tuple2',
					_0: player_,
					_1: _darrensiegel$elm_chess_client$Data_Tool$snd(_p18)
				};
			}
		}();
		var ui_ = function () {
		...
		var board = function () {
			...
			switch (_p9.ctor) {
				case 'Playing':
					return _darrensiegel$elm_chess_client$Model_Board$revert(_p9._0);
				case 'Moving':
					var _p11 = _p9._0;
					var _p10 = player.action;
					if (_p10.ctor === 'Moving') {
						return _darrensiegel$elm_chess_client$Model_Board$analyze(_p11);
					} else {
						return _darrensiegel$elm_chess_client$Model_Board$analyze(
							_elm_lang$core$Native_Utils.update(
								_p11,
								{
									board: _darrensiegel$elm_chess_client$Model_Board$remove(_p11)
								}));
					}
				case 'End':
					var _p14 = _p9._0;
					var ifCastling = function (fn) {
						return A2(_darrensiegel$elm_chess_client$Model_Board$whenCastling, fn, _p14);
					};
					var checkEnPassant = function (fn) {
						return A2(_darrensiegel$elm_chess_client$Model_Board$ifEnPassant, fn, _p14);
					};
					...
					var endSelect = function () {
						...
						if (_p13.ctor === 'Just') {
							return _elm_lang$core$Native_Utils.update(
								_p13._0,
								{board: _p17.board, piece: _p14.piece});
						} else {
							return A4(_darrensiegel$elm_chess_client$Data_Type$Selection, _p17.board, player, _darrensiegel$elm_chess_client$Data_Tool$vacantSquare, _darrensiegel$elm_chess_client$Data_Tool$nullPiece);
						}
					}();
					var eatPiece = F2(
						function (pc, bd) {
							return isClick ? _darrensiegel$elm_chess_client$Model_Board$lift(
								_elm_lang$core$Native_Utils.update(
									endSelect,
									{piece: pc})) : bd;
						});
					return A2(
						...
						A2(
							...
							_darrensiegel$elm_chess_client$Model_Board$place(
								_elm_lang$core$Native_Utils.update(
									endSelect,
									{
										board: _darrensiegel$elm_chess_client$Model_Board$remove(endSelect)
									}))));
				default:
					return _p17.board;
			}
		...
		var _p15 = event;
		if (_p15.ctor === 'Mdl') {
			var _p16 = A3(_debois$elm_mdl$Material$update, _darrensiegel$elm_chess_client$Data_Type$Mdl, _p15._0, ui_);
			var mat_ = _p16._0;
			var sub_ = _p16._1;
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
...
var _darrensiegel$elm_chess_client$State_Game$subscribe = function (_p20) {
	var _p21 = _p20;
	var _p23 = _p21.ui;
	var layout = A2(_debois$elm_mdl$Material_Layout$subs, _darrensiegel$elm_chess_client$Data_Type$Mdl, _p23.mdl);
	var $default = {
		ctor: '::',
		_0: layout,
		_1: {
			...
			_0: _elm_lang$keyboard$Keyboard$presses(
				function (k) {
					return (_elm_lang$core$Native_Utils.eq(
						...
						_elm_lang$core$Native_Utils.chr('`')) && _elm_lang$core$Native_Utils.eq(_p23.debug, false)) ? _darrensiegel$elm_chess_client$Data_Type$Debug(true) : (_elm_lang$core$Native_Utils.eq(
						_elm_lang$core$Char$fromCode(k),
						_elm_lang$core$Native_Utils.chr('`')) ? _darrensiegel$elm_chess_client$Data_Type$Debug(false) : _darrensiegel$elm_chess_client$Data_Type$Debug(_p23.debug));
				}),
			_1: {ctor: '[]'}
		}
	};
	var player = _darrensiegel$elm_chess_client$Data_Tool$fst(_p21.players);
	var _p22 = player.action;
	if (_p22.ctor === 'Moving') {
		return _elm_lang$core$Platform_Sub$batch(
			A2(
				_elm_lang$core$Basics_ops['++'],
...
var _darrensiegel$elm_chess_client$Model_SAN$toSAN = function (move) {
		...
		A2(
			...
			A2(
				...
				function (_p19) {
					return A2(
						_elm_lang$core$Tuple$mapSecond,
						_darrensiegel$elm_chess_client$Model_SAN$toSAN,
						A2(_elm_lang$core$Tuple$mapFirst, _darrensiegel$elm_chess_client$Model_SAN$toSAN, _p19));
				},
...
var _darrensiegel$elm_chess_client$View_Main$r_dragSvg = function (_p0) {
	var _p1 = _p0;
	var _p3 = _p1.piece;
	var o = _darrensiegel$elm_chess_client$Data_Tool$toBoardPosition(_p1.square.location);
		...
		return A3(
			...
			'piece',
			{
				...
				_0: _elm_lang$html$Html_Attributes$style(
					{
						ctor: '::',
						_0: A2(_darrensiegel$elm_chess_client$Data_Tool_ops['=>'], 'position', 'absolute'),
						_1: {
							ctor: '::',
							_0: A2(
								_darrensiegel$elm_chess_client$Data_Tool_ops['=>'],
		...
		_0: _elm_lang$html$Html_Attributes$style(
			{
				...
				_0: A2(
					_darrensiegel$elm_chess_client$Data_Tool_ops['=>'],
					'top',
					_darrensiegel$elm_chess_client$Data_Tool$px(y)),
				_1: {
					ctor: '::',
					_0: A2(
						_darrensiegel$elm_chess_client$Data_Tool_ops['=>'],
						'left',
						_darrensiegel$elm_chess_client$Data_Tool$px(x)),
					_1: {ctor: '[]'}
				}
			}),
		_1: {ctor: '[]'}
			...
			function (sq, mem) {
				...
				if (_p11.ctor === 'Just') {
					...
					if (_p12.ctor === 'Black') {
						return {
							ctor: '_Tuple2',
							_0: _darrensiegel$elm_chess_client$Data_Tool$fst(mem),
							_1: A2(
								_elm_lang$core$Basics_ops['++'],
								_darrensiegel$elm_chess_client$Data_Tool$snd(mem),
								{
									ctor: '::',
									_0: sq,
									_1: {ctor: '[]'}
						...
						return {
							...
							_0: A2(
								_elm_lang$core$Basics_ops['++'],
								_darrensiegel$elm_chess_client$Data_Tool$fst(mem),
								{
									ctor: '::',
									_0: sq,
									_1: {ctor: '[]'}
								}),
							_1: _darrensiegel$elm_chess_client$Data_Tool$snd(mem)
						};
					}
				} else {
					return mem;
	...
	return A3(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				_darrensiegel$elm_chess_client$Data_Tool$fst(pieces)),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
					...
					_darrensiegel$elm_chess_client$Data_Tool$snd(pieces)),
				_1: {ctor: '[]'}
			}
		});
};
			...
			_1: {
				...
				_0: _elm_lang$html$Html_Attributes$class(
					_elm_lang$core$String$toLower(
						_elm_lang$core$Basics$toString(
							_darrensiegel$elm_chess_client$Data_Tool$fst(_p19).color))),
				_1: {ctor: '[]'}
			}
		},
		{
			...
			_0: _darrensiegel$elm_chess_client$View_Main$r_player(
				_darrensiegel$elm_chess_client$Data_Tool$fst(_p19)),
			_1: {
				ctor: '::',
...
var _darrensiegel$elm_chess_client$View_Main$render = function (_p20) {
	...
	return A4(
		...
		_darrensiegel$elm_chess_client$Data_Type$Mdl,
		_p24.mdl,
		{
			ctor: '::',
