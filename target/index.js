...
var _darrensiegel$elm_chess_client$Data_Type$Game = F3(
	function (a, b, c) {
		return {ui: a, chess: b, players: c};
	});
var _darrensiegel$elm_chess_client$Data_Type$Chess = F2(
	function (a, b) {
		return {board: a, history: b};
	});
var _darrensiegel$elm_chess_client$Data_Type$Piece = F8(
	function (a, b, c, d, e, f, g, h) {
		return {point: a, drag: b, color: c, role: d, tick: e, lock: f, check: g, path: h};
	});
var _darrensiegel$elm_chess_client$Data_Type$Square = F4(
	function (a, b, c, d) {
		return {point: a, piece: b, valid: c, active: d};
	});
var _darrensiegel$elm_chess_client$Data_Type$Selection = F2(
	function (a, b) {
		return {focus: a, piece: b};
	});
var _darrensiegel$elm_chess_client$Data_Type$Move = F7(
	function (a, b, c, d, e, f, g) {
		return {start: a, end: b, piece: c, capture: d, pin: e, check: f, enPassant: g};
	});
var _darrensiegel$elm_chess_client$Data_Type$Player = F4(
	function (a, b, c, d) {
...
var _darrensiegel$elm_chess_client$Data_Type$Bishop = {ctor: 'Bishop'};
var _darrensiegel$elm_chess_client$Data_Type$Rook = {ctor: 'Rook'};
var _darrensiegel$elm_chess_client$Data_Type$Pawn = {ctor: 'Pawn'};
var _darrensiegel$elm_chess_client$Data_Type$Idle = {ctor: 'Idle'};
var _darrensiegel$elm_chess_client$Data_Type$End = function (a) {
	return {ctor: 'End', _0: a};
};
var _darrensiegel$elm_chess_client$Data_Type$Playing = function (a) {
...
var _darrensiegel$elm_chess_client$Data_Type$GUI = function (a) {
	return {ctor: 'GUI', _0: a};
};
var _darrensiegel$elm_chess_client$Data_Type$Drop = function (a) {
	return {ctor: 'Drop', _0: a};
};
var _darrensiegel$elm_chess_client$Data_Type$Drag = function (a) {
	return {ctor: 'Drag', _0: a};
};
var _darrensiegel$elm_chess_client$Data_Type$Click = function (a) {
	return {ctor: 'Click', _0: a};
};

var _darrensiegel$elm_chess_client$Data_Pure$newHistory = {ctor: '[]'};
...
var _darrensiegel$elm_chess_client$Data_Pure$originPos = {x: 0, y: 0};
var _darrensiegel$elm_chess_client$Data_Pure$origin = A2(_chendrix$elm_matrix$Matrix$loc, 0, 0);
var _darrensiegel$elm_chess_client$Data_Pure$joker = A8(
	_darrensiegel$elm_chess_client$Data_Type$Piece,
	_darrensiegel$elm_chess_client$Data_Pure$origin,
	_darrensiegel$elm_chess_client$Data_Pure$originPos,
	...
	false,
	{ctor: '[]'});
var _darrensiegel$elm_chess_client$Data_Pure$vacantSquare = A4(_darrensiegel$elm_chess_client$Data_Type$Square, _darrensiegel$elm_chess_client$Data_Pure$origin, _elm_lang$core$Maybe$Nothing, false, false);
var _darrensiegel$elm_chess_client$Data_Pure$nullBoard = _chendrix$elm_matrix$Matrix$fromList(
	{
		ctor: '::',
		_0: {
			ctor: '::',
			_0: _darrensiegel$elm_chess_client$Data_Pure$vacantSquare,
			_1: {ctor: '[]'}
		},
		_1: {ctor: '[]'}
	});
var _darrensiegel$elm_chess_client$Data_Pure$noMove = A7(_darrensiegel$elm_chess_client$Data_Type$Move, _darrensiegel$elm_chess_client$Data_Pure$origin, _darrensiegel$elm_chess_client$Data_Pure$origin, _darrensiegel$elm_chess_client$Data_Pure$joker, _elm_lang$core$Maybe$Nothing, _elm_lang$core$Maybe$Nothing, false, false);
var _darrensiegel$elm_chess_client$Data_Pure$startCommands = {
	ctor: '::',
	_0: _debois$elm_mdl$Material_Layout$sub0(_darrensiegel$elm_chess_client$Data_Type$GUI),
	_1: {ctor: '[]'}
};
var _darrensiegel$elm_chess_client$Data_Pure$newGame = function () {
	...
	var chess = A2(_darrensiegel$elm_chess_client$Data_Type$Chess, _darrensiegel$elm_chess_client$Data_Pure$nullBoard, _darrensiegel$elm_chess_client$Data_Pure$newHistory);
	return A3(_darrensiegel$elm_chess_client$Data_Type$Game, ui, chess, players);
}();
...
var _darrensiegel$elm_chess_client$Config_Settings$squareSize = 54;
var _darrensiegel$elm_chess_client$Config_Settings$boardside = A2(_elm_lang$core$List$range, 0, 7);

var _darrensiegel$elm_chess_client$Data_Cast$fromMousePosition = function (position) {
	var y = ((position.y - 56) / _darrensiegel$elm_chess_client$Config_Settings$squareSize) | 0;
	var x = (position.x / _darrensiegel$elm_chess_client$Config_Settings$squareSize) | 0;
	return A2(_elm_lang$mouse$Mouse$Position, x, y);
};
var _darrensiegel$elm_chess_client$Data_Cast$toPosition = function (_p0) {
	var _p1 = _p0;
	return {x: _p1._1, y: _p1._0};
};
var _darrensiegel$elm_chess_client$Data_Cast$toBoardPosition = function (location) {
	var p = _darrensiegel$elm_chess_client$Data_Cast$toPosition(location);
	var x = p.x * _darrensiegel$elm_chess_client$Config_Settings$squareSize;
	var y = p.y * _darrensiegel$elm_chess_client$Config_Settings$squareSize;
	return A2(_elm_lang$mouse$Mouse$Position, x, y);
};
var _darrensiegel$elm_chess_client$Data_Cast$toLocations = _elm_lang$core$List$map(
	_elm_lang$core$Basics$uncurry(_chendrix$elm_matrix$Matrix$loc));
var _darrensiegel$elm_chess_client$Data_Cast$toLocation = function (p) {
	return A2(_chendrix$elm_matrix$Matrix$loc, p.y, p.x);
};
var _darrensiegel$elm_chess_client$Data_Cast$toBoardLocation = function (ps) {
	return _darrensiegel$elm_chess_client$Data_Cast$toLocation(
		_darrensiegel$elm_chess_client$Data_Cast$fromMousePosition(ps));
};
var _darrensiegel$elm_chess_client$Data_Cast$pos = F2(
	function (x_, y_) {
		return {x: x_, y: y_};
	});
var _darrensiegel$elm_chess_client$Data_Cast$tupleToList = function (t) {
	return {
		ctor: '::',
...
var _darrensiegel$elm_chess_client$Data_Query$isUntouched = function (square) {
	var _p2 = square.piece;
	if (_p2.ctor === 'Just') {
		return _elm_lang$core$Native_Utils.eq(_p2._0.tick, 1);
	} else {
		return false;
	}
};
var _darrensiegel$elm_chess_client$Data_Query$isNewRook = function (square) {
	var _p3 = square.piece;
	if (_p3.ctor === 'Just') {
		var _p5 = _p3._0;
		var _p4 = _p5.role;
		if (_p4.ctor === 'Rook') {
			return _elm_lang$core$Native_Utils.eq(_p5.tick, 0);
		} else {
			return false;
		}
	} else {
...
var _darrensiegel$elm_chess_client$Data_Query$isKing = function (piece) {
	var _p6 = piece.role;
	if (_p6.ctor === 'King') {
		return true;
	} else {
...
var _darrensiegel$elm_chess_client$Data_Query$isKingSquare = function (sq) {
	var _p7 = sq.piece;
	if (_p7.ctor === 'Just') {
		return _darrensiegel$elm_chess_client$Data_Query$isKing(_p7._0);
	} else {
		return false;
	}
};
var _darrensiegel$elm_chess_client$Data_Query$isOccupied = function (square) {
	return _elm_community$maybe_extra$Maybe_Extra$isJust(square.piece);
};
var _darrensiegel$elm_chess_client$Data_Query$isVacant = function (_p8) {
	return !_darrensiegel$elm_chess_client$Data_Query$isOccupied(_p8);
};
var _darrensiegel$elm_chess_client$Data_Query$withPiece = F2(
	function (fn, square) {
		var _p9 = square.piece;
		if (_p9.ctor === 'Just') {
			return fn(_p9._0);
		} else {
			return false;
...
var _darrensiegel$elm_chess_client$Data_Query$stationary = function (piece) {
	return _elm_lang$core$Native_Utils.eq(piece.tick, 0);
};
var _darrensiegel$elm_chess_client$Data_Query$isPinner = function (piece) {
	var _p10 = piece.role;
	switch (_p10.ctor) {
		case 'Bishop':
			return true;
...
var _darrensiegel$elm_chess_client$Data_Query$passanting = function (pawn) {
	var _p11 = pawn.point;
	var y = _p11._0;
	var x = _p11._1;
	var _p12 = pawn.color;
	if (_p12.ctor === 'White') {
		return _elm_lang$core$Native_Utils.eq(y, 3);
	} else {
		return _elm_lang$core$Native_Utils.eq(y, 4);
	}
};
var _darrensiegel$elm_chess_client$Data_Query$opponent = function (col) {
	var _p13 = col;
	if (_p13.ctor === 'White') {
		return _darrensiegel$elm_chess_client$Data_Type$Black;
	} else {
		return _darrensiegel$elm_chess_client$Data_Type$White;
	}
};
var _darrensiegel$elm_chess_client$Data_Query$isColor = F2(
	function (color, piece) {
		return _elm_lang$core$Native_Utils.eq(piece.color, color);
	});
var _darrensiegel$elm_chess_client$Data_Query$friendlyOccupied = F2(
	function (color, square) {
		return A2(
			_darrensiegel$elm_chess_client$Data_Query$withPiece,
...
var _darrensiegel$elm_chess_client$Depo_Lib$px = function (value) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Basics$toString(value),
		'px');
};
var _darrensiegel$elm_chess_client$Depo_Lib$isPositive = function (n) {
	return !_elm_lang$core$Native_Utils.eq(
		_elm_lang$core$Basics$negate(
			_elm_lang$core$Basics$abs(n)),
		n);
};
var _darrensiegel$elm_chess_client$Depo_Lib$mapBoth = F2(
	function (fn, tup) {
		return A2(
			_elm_lang$core$Tuple$mapSecond,
			fn,
			A2(_elm_lang$core$Tuple$mapFirst, fn, tup));
	});
var _darrensiegel$elm_chess_client$Depo_Lib$foldl1 = F2(
	function (f, xs) {
		var mf = F2(
			function (x, m) {
				return _elm_lang$core$Maybe$Just(
					function () {
						...
						if (_p0.ctor === 'Nothing') {
							...
							return A2(f, _p0._0, x);
						}
					}());
			});
		return A3(_elm_lang$core$List$foldl, mf, _elm_lang$core$Maybe$Nothing, xs);
	});
var _darrensiegel$elm_chess_client$Depo_Lib$last = _darrensiegel$elm_chess_client$Depo_Lib$foldl1(
	_elm_lang$core$Basics$flip(_elm_lang$core$Basics$always));
var _darrensiegel$elm_chess_client$Depo_Lib$swap = function (_p1) {
	var _p2 = _p1;
	return {ctor: '_Tuple2', _0: _p2._1, _1: _p2._0};
};
var _darrensiegel$elm_chess_client$Depo_Lib$snd = _elm_lang$core$Tuple$second;
var _darrensiegel$elm_chess_client$Depo_Lib$fst = _elm_lang$core$Tuple$first;
var _darrensiegel$elm_chess_client$Depo_Lib_ops = _darrensiegel$elm_chess_client$Depo_Lib_ops || {};
_darrensiegel$elm_chess_client$Depo_Lib_ops['??'] = F2(
	function (a, b) {
		return a ? b : {ctor: '[]'};
	});
var _darrensiegel$elm_chess_client$Depo_Lib_ops = _darrensiegel$elm_chess_client$Depo_Lib_ops || {};
...
_darrensiegel$elm_chess_client$Depo_Lib_ops['<<$'] = F2(
	function (xs, f) {
		return A2(_elm_lang$core$List$map, f, xs);
	});
var _darrensiegel$elm_chess_client$Depo_Lib_ops = _darrensiegel$elm_chess_client$Depo_Lib_ops || {};
_darrensiegel$elm_chess_client$Depo_Lib_ops['$>>'] = F2(
	function (f, xs) {
...
_darrensiegel$elm_chess_client$Depo_Lib_ops['$$>'] = F2(
	function (fs, xs) {
		return A2(
			_elm_lang$core$List$concatMap,
			function (f) {
				return A2(_darrensiegel$elm_chess_client$Depo_Lib_ops['$>>'], f, xs);
			},
			fs);
	});
var _darrensiegel$elm_chess_client$Depo_Lib$liftAp = F3(
	function (fn, l1, l2) {
		return A2(
			_darrensiegel$elm_chess_client$Depo_Lib_ops['$$>'],
			A2(_darrensiegel$elm_chess_client$Depo_Lib_ops['$>>'], fn, l1),
			l2);
	});

var _darrensiegel$elm_chess_client$Depo_SAN$fromRole = function (fig) {
	var _p0 = fig;
	switch (_p0.ctor) {
		case 'Pawn':
...
var _darrensiegel$elm_chess_client$Depo_SAN$toRole = function (ch) {
	var _p1 = _elm_lang$core$Char$toLower(ch);
	switch (_p1.valueOf()) {
		case 'p':
			return _darrensiegel$elm_chess_client$Data_Type$Pawn;
		case 'n':
			return _darrensiegel$elm_chess_client$Data_Type$Knight;
		case 'b':
			return _darrensiegel$elm_chess_client$Data_Type$Bishop;
		case 'r':
			return _darrensiegel$elm_chess_client$Data_Type$Rook;
		case 'q':
			return _darrensiegel$elm_chess_client$Data_Type$Queen;
		case 'k':
...
var _darrensiegel$elm_chess_client$Depo_SAN$toSANLocation = function (san) {
	var rank = A2(_elm_lang$core$String$dropLeft, 1, san);
	var y = function () {
		var _p2 = _elm_lang$core$String$toInt(rank);
		if (_p2.ctor === 'Ok') {
			var _p3 = _p2._0;
			return ((_elm_lang$core$Native_Utils.cmp(_p3, 0) > -1) && (_elm_lang$core$Native_Utils.cmp(_p3, 8) < 0)) ? _elm_lang$core$Maybe$Just(
				_elm_lang$core$Basics$abs(8 - _p3)) : _elm_lang$core$Maybe$Nothing;
		} else {
			return _elm_lang$core$Maybe$Nothing;
		}
	}();
	var file = A2(_elm_lang$core$String$dropRight, 1, san);
	var x_ = function (_p4) {
		return A2(
			F2(
				function (x, y) {
					return A2(_darrensiegel$elm_chess_client$Depo_Lib_ops['<?'], x, y);
				}),
		...
		_elm_lang$core$String$toLower(file));
	var x = function () {
		var _p5 = A2(
		...
		if (_p5.ctor === 'Ok') {
			var x1 = _p5._0 - 97;
			return ((_elm_lang$core$Native_Utils.cmp(x1, 0) > -1) && (_elm_lang$core$Native_Utils.cmp(x1, 8) < 0)) ? _elm_lang$core$Maybe$Just(x1) : _elm_lang$core$Maybe$Nothing;
		} else {
			return _elm_lang$core$Maybe$Nothing;
		}
	}();
	return A2(
		_elm_community$maybe_extra$Maybe_Extra_ops['?'],
		A3(_elm_lang$core$Maybe$map2, _chendrix$elm_matrix$Matrix$loc, y, x),
		_darrensiegel$elm_chess_client$Data_Pure$origin);
};
var _darrensiegel$elm_chess_client$Depo_SAN$toSAN = function (move) {
	...
	var letter = function (p) {
		var c = _darrensiegel$elm_chess_client$Depo_SAN$fromRole(p.role);
	...
	return A2(
		_elm_lang$core$Basics_ops['++'],
		function () {
			var _p8 = move.capture;
			if (_p8.ctor === 'Just') {
				return A2(wCapture, _p8._0, move);
			} else {
...
var _darrensiegel$elm_chess_client$Depo_Moves$right = F2(
	function (n, _p0) {
		var _p1 = _p0;
		return A2(_chendrix$elm_matrix$Matrix$loc, _p1._0, _p1._1 + n);
	});
var _darrensiegel$elm_chess_client$Depo_Moves$left = F2(
	function (n, _p2) {
		var _p3 = _p2;
		return A2(_chendrix$elm_matrix$Matrix$loc, _p3._0, _p3._1 - n);
	});
var _darrensiegel$elm_chess_client$Depo_Moves$down = F2(
	function (n, _p4) {
		var _p5 = _p4;
		return A2(_chendrix$elm_matrix$Matrix$loc, _p5._0 + n, _p5._1);
	});
var _darrensiegel$elm_chess_client$Depo_Moves$up = F2(
	function (n, _p6) {
		var _p7 = _p6;
		return A2(_chendrix$elm_matrix$Matrix$loc, _p7._0 - n, _p7._1);
	});
var _darrensiegel$elm_chess_client$Depo_Moves$forwardMove = function (piece) {
	var _p8 = piece.color;
	if (_p8.ctor === 'White') {
		return _darrensiegel$elm_chess_client$Depo_Moves$up;
	} else {
		return _darrensiegel$elm_chess_client$Depo_Moves$down;
	}
};
var _darrensiegel$elm_chess_client$Depo_Moves$backwardMove = function (piece) {
	var _p9 = piece.color;
	if (_p9.ctor === 'White') {
		return _darrensiegel$elm_chess_client$Depo_Moves$down;
	} else {
...
var _darrensiegel$elm_chess_client$Depo_Moves$cardinals = {
	ctor: '_Tuple2',
	_0: {
		ctor: '::',
		_0: _darrensiegel$elm_chess_client$Depo_Moves$up,
		_1: {
			ctor: '::',
			_0: _darrensiegel$elm_chess_client$Depo_Moves$down,
			_1: {ctor: '[]'}
		}
	},
	_1: {
		ctor: '::',
		_0: _darrensiegel$elm_chess_client$Depo_Moves$left,
		_1: {
			ctor: '::',
			_0: _darrensiegel$elm_chess_client$Depo_Moves$right,
			_1: {ctor: '[]'}
		}
	}
};
var _darrensiegel$elm_chess_client$Depo_Moves$straights = function () {
	var wrap = function (_p10) {
		return A2(
			F2(
				function (x, y) {
					return A2(_darrensiegel$elm_chess_client$Depo_Lib_ops['$>>'], x, y);
			...
			_elm_lang$core$List$concat(
				_darrensiegel$elm_chess_client$Data_Cast$tupleToList(_p10)));
	};
	return wrap(_darrensiegel$elm_chess_client$Depo_Moves$cardinals);
}();
var _darrensiegel$elm_chess_client$Depo_Moves$diagonals = function () {
	var cartesian = function (_p11) {
		return _elm_lang$core$Basics$uncurry(
			_darrensiegel$elm_chess_client$Depo_Lib$liftAp(
				F2(
					function (x, y) {
						return A2(_elm_lang$core$Basics_ops['++'], x, y);
					})))(
			A2(
				_darrensiegel$elm_chess_client$Depo_Lib$mapBoth,
				F2(
					function (x, y) {
						return A2(_darrensiegel$elm_chess_client$Depo_Lib_ops['$>>'], x, y);
					})(_elm_lang$core$List$singleton),
	...
	return cartesian(_darrensiegel$elm_chess_client$Depo_Moves$cardinals);
}();
var _darrensiegel$elm_chess_client$Depo_Moves$asterisk = A2(_elm_lang$core$Basics_ops['++'], _darrensiegel$elm_chess_client$Depo_Moves$diagonals, _darrensiegel$elm_chess_client$Depo_Moves$straights);
var _darrensiegel$elm_chess_client$Depo_Moves$idle = function (l) {
	return l;
};
var _darrensiegel$elm_chess_client$Depo_Moves$stepSearch = F5(
	function (piece, board, semaphores, transforms, directions) {
		var finish = _darrensiegel$elm_chess_client$Depo_Lib$snd(transforms);
		var relay = _darrensiegel$elm_chess_client$Depo_Lib$fst(transforms);
		var red = _darrensiegel$elm_chess_client$Depo_Lib$snd(semaphores);
		var green = _darrensiegel$elm_chess_client$Depo_Lib$fst(semaphores);
		var step = A2(
			_elm_lang$core$List$map,
			F2(
				function (x, y) {
			...
			_darrensiegel$elm_chess_client$Config_Settings$boardside);
		var stop = false;
		var walk = F3(
			function (ways, depth, _p12) {
				var _p13 = _p12;
				var _p16 = _p13._1;
				var _p15 = _p13._0;
				if (_p15) {
					var tracePath = _elm_lang$core$Native_Utils.eq(
						_elm_lang$core$List$length(ways),
						1) ? A2(
						_elm_community$maybe_extra$Maybe_Extra_ops['?'],
						_elm_lang$core$List$head(ways),
						_elm_lang$core$Basics$always(_darrensiegel$elm_chess_client$Depo_Moves$idle))(depth) : A2(
						_elm_community$maybe_extra$Maybe_Extra_ops['?'],
						A2(
							_darrensiegel$elm_chess_client$Depo_Lib$foldl1,
							F2(
								function (x, y) {
									return function (_p14) {
										return y(
							...
							A2(
								...
								ways)),
						_darrensiegel$elm_chess_client$Depo_Moves$idle);
					var target = A2(
						_elm_community$maybe_extra$Maybe_Extra_ops['?'],
						A2(
							_chendrix$elm_matrix$Matrix$get,
							tracePath(piece.point),
							board),
						_darrensiegel$elm_chess_client$Data_Pure$vacantSquare);
					return green(target) ? {
						ctor: '_Tuple2',
						_0: _p15,
						_1: A2(relay, tracePath, _p16)
					} : (red(target) ? {
						ctor: '_Tuple2',
						_0: stop,
						_1: A2(finish, tracePath, _p16)
					} : {ctor: '_Tuple2', _0: stop, _1: _p16});
				} else {
					return {ctor: '_Tuple2', _0: stop, _1: _p16};
				}
			});
		var go = true;
		var memo = {
		...
		var search = F2(
			function (ways, _p17) {
				...
				return A3(
					_elm_lang$core$List$foldl,
					walk(ways),
					{ctor: '_Tuple2', _0: go, _1: _p18._1},
					step);
			});
		var _p19 = A3(_elm_lang$core$List$foldl, search, memo, directions);
		var paths = _p19._1;
		return paths;
	});
var _darrensiegel$elm_chess_client$Depo_Moves$linearMove = F3(
	function (piece, board, directions) {
		var consAll = {
			ctor: '_Tuple2',
			_0: F2(
				function (x, y) {
		...
		var search = A2(_darrensiegel$elm_chess_client$Depo_Moves$stepSearch, piece, board);
		var stopWhen = function (_p20) {
			return !A2(_darrensiegel$elm_chess_client$Data_Query$friendlyOccupied, piece.color, _p20);
		};
		var searchWhen = _darrensiegel$elm_chess_client$Data_Query$isVacant;
		return A3(
			search,
			{ctor: '_Tuple2', _0: searchWhen, _1: stopWhen},
			consAll,
			directions);
	});

var _darrensiegel$elm_chess_client$Depo_FEN$toPiece = F2(
	function (ch, point) {
		var check = false;
		var lock = false;
		var tick = 0;
		var role = _darrensiegel$elm_chess_client$Depo_SAN$toRole(ch);
		var path = {
			ctor: '::',
			_0: point,
			_1: {ctor: '[]'}
		};
		var drag = _darrensiegel$elm_chess_client$Data_Cast$toBoardPosition(point);
		var newPiece = function (color) {
			return A8(_darrensiegel$elm_chess_client$Data_Type$Piece, point, drag, color, role, tick, lock, check, path);
		};
...
var _darrensiegel$elm_chess_client$Depo_FEN$toSquare = F2(
	function (lc, ch) {
		var occupied = A4(
			_darrensiegel$elm_chess_client$Data_Type$Square,
			lc,
			_elm_lang$core$Maybe$Just(
				A2(_darrensiegel$elm_chess_client$Depo_FEN$toPiece, ch, lc)),
			false,
			false);
		var vacant = A4(_darrensiegel$elm_chess_client$Data_Type$Square, lc, _elm_lang$core$Maybe$Nothing, false, false);
		return _elm_lang$core$Native_Utils.eq(
			_darrensiegel$elm_chess_client$Depo_SAN$toRole(ch),
			_darrensiegel$elm_chess_client$Data_Type$Joker) ? vacant : occupied;
	});
var _darrensiegel$elm_chess_client$Depo_FEN$expandMatch = function (_p0) {
	var _p1 = _p0;
	return A2(
		...
		A2(
			...
			0,
			_elm_lang$core$String$toInt(_p1.match)),
		' ');
};
var _darrensiegel$elm_chess_client$Depo_FEN$expand = function (s) {
	return A4(
		_elm_lang$core$Regex$replace,
		_elm_lang$core$Regex$All,
		_elm_lang$core$Regex$regex('[12345678]'),
		_darrensiegel$elm_chess_client$Depo_FEN$expandMatch,
		s);
};
var _darrensiegel$elm_chess_client$Depo_FEN$toRank = F2(
	function (y, row) {
		var points = A2(
			_elm_lang$core$List$map,
			_elm_lang$core$Basics$uncurry(_chendrix$elm_matrix$Matrix$loc),
			A2(
				_elm_lang$core$List$map,
				_darrensiegel$elm_chess_client$Depo_Lib$swap,
				A3(
					_elm_lang$core$List$map2,
					F2(
						function (v0, v1) {
		...
		var pieces = _elm_lang$core$String$toList(
			_darrensiegel$elm_chess_client$Depo_FEN$expand(row));
		return A3(_elm_lang$core$List$map2, _darrensiegel$elm_chess_client$Depo_FEN$toSquare, points, pieces);
	});
var _darrensiegel$elm_chess_client$Depo_FEN$parsePieces = function (s) {
	return _chendrix$elm_matrix$Matrix$fromList(
		A3(
			_elm_lang$core$List$map2,
			_darrensiegel$elm_chess_client$Depo_FEN$toRank,
			_darrensiegel$elm_chess_client$Config_Settings$boardside,
			A2(_elm_lang$core$String$split, '/', s)));
};
var _darrensiegel$elm_chess_client$Depo_FEN$fenPassant = F3(
	function (coor, player, board) {
		var jester = _elm_lang$core$Native_Utils.update(
			_darrensiegel$elm_chess_client$Data_Pure$joker,
			{
				color: _darrensiegel$elm_chess_client$Data_Query$opponent(player)
			});
		var capturePoint = _darrensiegel$elm_chess_client$Depo_SAN$toSANLocation(coor);
		var opponentPoint = A3(_darrensiegel$elm_chess_client$Depo_Moves$forwardMove, jester, 1, capturePoint);
		var adjustPassant = F2(
			function (lc, sq) {
				if (_elm_lang$core$Native_Utils.eq(lc, opponentPoint)) {
					var _p2 = sq.piece;
					if (_p2.ctor === 'Just') {
						var _p4 = _p2._0;
						var _p3 = _p4.role;
						if (_p3.ctor === 'Pawn') {
							return _elm_lang$core$Native_Utils.update(
								sq,
								{
									piece: _elm_lang$core$Maybe$Just(
										_elm_lang$core$Native_Utils.update(
											_p4,
											{
												tick: 1,
												path: A2(
													...
													{
														ctor: '::',
														_0: A3(_darrensiegel$elm_chess_client$Depo_Moves$forwardMove, jester, 1, capturePoint),
														_1: {ctor: '[]'}
													})
											}))
								});
		...
		return A2(_chendrix$elm_matrix$Matrix$mapWithLocation, adjustPassant, board);
	});
var _darrensiegel$elm_chess_client$Depo_FEN$maybeContains = F2(
	function (str, value) {
		var _p5 = str;
		if (_p5.ctor === 'Just') {
			return A2(_elm_lang$core$String$contains, value, _p5._0);
		} else {
			return false;
		}
	});
var _darrensiegel$elm_chess_client$Depo_FEN$enPassantBoard = 'rnbqkbnr/1ppppppp/8/pP6/8/8/P1PPPPPP/RNBQKBNR w KQkq a6 0 1';
var _darrensiegel$elm_chess_client$Depo_FEN$initialPieces = 'rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR';
var _darrensiegel$elm_chess_client$Depo_FEN$openingBoard = A2(_elm_lang$core$Basics_ops['++'], _darrensiegel$elm_chess_client$Depo_FEN$initialPieces, ' w KQkq - 0 1');
var _darrensiegel$elm_chess_client$Depo_FEN$fromFEN = function (fen) {
	...
	var colorTurn = function () {
		var _p6 = A2(
			_elm_community$maybe_extra$Maybe_Extra_ops['?'],
			A2(_elm_lang$core$Array$get, 1, parts),
			'w');
		switch (_p6) {
			case 'w':
				return _darrensiegel$elm_chess_client$Data_Type$White;
	...
	var processPassant = (!_elm_lang$core$Native_Utils.eq(passantPoint, '-')) ? A2(_darrensiegel$elm_chess_client$Depo_FEN$fenPassant, passantPoint, colorTurn) : _elm_lang$core$Basics$identity;
	var board = _darrensiegel$elm_chess_client$Depo_FEN$parsePieces(
		A2(
			_elm_lang$core$Maybe$withDefault,
			_darrensiegel$elm_chess_client$Depo_FEN$initialPieces,
			A2(_elm_lang$core$Array$get, 0, parts)));
	return processPassant(board);
};

var _darrensiegel$elm_chess_client$Model_Rules$isChecking = F2(
...
var _darrensiegel$elm_chess_client$Model_Rules$isCastling = function (piece) {
	var castlesLocations = _darrensiegel$elm_chess_client$Data_Cast$toLocations(
		{
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 7, _1: 6},
			_1: {
				ctor: '::',
...
var _darrensiegel$elm_chess_client$Model_Rules$capturing = F2(
	function (player, selection) {
		return A2(
			...
			A2(
				_elm_lang$core$Maybe$map,
				function (s) {
					return !_elm_lang$core$Native_Utils.eq(s.piece.color, player.color);
				},
				selection));
	});
var _darrensiegel$elm_chess_client$Model_Rules$startingRank = function (piece) {
...
var _darrensiegel$elm_chess_client$Model_Rules$starting = function (piece) {
	var _p5 = piece.point;
	var y = _p5._0;
	var x = _p5._1;
	return _elm_lang$core$Native_Utils.eq(
		_darrensiegel$elm_chess_client$Model_Rules$startingRank(piece),
		y);
};
var _darrensiegel$elm_chess_client$Model_Rules$withPinner = F3(
	function (piece, board, fn) {
		var _p6 = piece.role;
		switch (_p6.ctor) {
			case 'Bishop':
				return A3(fn, piece, board, _darrensiegel$elm_chess_client$Depo_Moves$diagonals);
			case 'Rook':
				return A3(fn, piece, board, _darrensiegel$elm_chess_client$Depo_Moves$straights);
			case 'Queen':
				return A3(fn, piece, board, _darrensiegel$elm_chess_client$Depo_Moves$asterisk);
			default:
				return {ctor: '[]'};
		}
	});
var _darrensiegel$elm_chess_client$Model_Rules$withKing = F3(
	function (piece, board, fn) {
		var _p7 = piece.role;
		if (_p7.ctor === 'King') {
			return A2(fn, piece, board);
		} else {
			return board;
		}
	});
var _darrensiegel$elm_chess_client$Model_Rules$findThreat = F2(
	function (piece, board) {
		var stopWhen = function (sq) {
			var pinner = function () {
				var _p8 = sq.piece;
				if (_p8.ctor === 'Just') {
					var _p9 = _p8._0;
					return _darrensiegel$elm_chess_client$Data_Query$isPinner(_p9) && (!_elm_lang$core$Native_Utils.eq(_p9.color, piece.color));
				} else {
					return false;
				}
			}();
		...
		var res = A5(
			_darrensiegel$elm_chess_client$Depo_Moves$stepSearch,
			piece,
			board,
			{ctor: '_Tuple2', _0: _darrensiegel$elm_chess_client$Data_Query$isVacant, _1: stopWhen},
			{
				ctor: '_Tuple2',
				_0: _elm_lang$core$Basics$flip(_elm_lang$core$Basics$always),
				_1: F2(
					function (x, y) {
						return {ctor: '::', _0: x, _1: y};
					})
			},
			_darrensiegel$elm_chess_client$Depo_Moves$asterisk);
		var _p10 = A2(_elm_lang$core$Debug$log, '-', res);
		return res;
	});
var _darrensiegel$elm_chess_client$Model_Rules$findKing = F2(
	function (piece, board) {
		return A4(
			_darrensiegel$elm_chess_client$Depo_Moves$stepSearch,
			piece,
			board,
			{ctor: '_Tuple2', _0: _darrensiegel$elm_chess_client$Data_Query$isVacant, _1: _darrensiegel$elm_chess_client$Data_Query$isKingSquare},
			{
				ctor: '_Tuple2',
				_0: _elm_lang$core$Basics$flip(_elm_lang$core$Basics$always),
				_1: F2(
...
var _darrensiegel$elm_chess_client$Model_Rules$findNextOpponent = F2(
	function (piece, board) {
		return A4(
			_darrensiegel$elm_chess_client$Depo_Moves$stepSearch,
			piece,
			...
			{
				ctor: '_Tuple2',
				_0: _darrensiegel$elm_chess_client$Data_Query$isVacant,
				_1: function (_p11) {
					return !A2(_darrensiegel$elm_chess_client$Data_Query$friendlyOccupied, piece.color, _p11);
				}
			},
			{
				ctor: '_Tuple2',
...
var _darrensiegel$elm_chess_client$Model_Rules$distinct = F3(
	function (piece, board, locations) {
		return A2(
			_elm_lang$core$List$filterMap,
			function (move) {
				var _p12 = A2(
					...
					board);
				if (_p12.ctor === 'Just') {
					var _p13 = _p12._0.piece;
					if (_p13.ctor === 'Just') {
						return _elm_lang$core$Native_Utils.eq(_p13._0.color, piece.color) ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(move);
					} else {
						return _elm_lang$core$Maybe$Just(move);
					}
				} else {
					return _elm_lang$core$Maybe$Nothing;
				}
...
var _darrensiegel$elm_chess_client$Model_Rules$validate = F4(
	function (piece, board, _p14, moves) {
		var _p15 = _p14;
		var _p16 = _p15._0;
		var target = A2(
			_chendrix$elm_matrix$Matrix$get,
		...
		return A2(
			...
			A2(
				_elm_lang$core$Maybe$map,
				function (square) {
					return _p15._1(square) ? {ctor: '::', _0: _p16, _1: moves} : moves;
				},
				target),
			moves);
	});
var _darrensiegel$elm_chess_client$Model_Rules$castle = F2(
	function (king, board) {
		var withKing = function (fn) {
			return A2(fn, king, board);
		};
		var analizeK = A2(
			_elm_lang$core$List$foldl,
			withKing(_darrensiegel$elm_chess_client$Model_Rules$validate),
			{ctor: '[]'});
		var clear = function (tests) {
			return _elm_lang$core$Native_Utils.eq(
				_elm_lang$core$List$length(
					analizeK(tests)),
				_elm_lang$core$List$length(tests));
		};
		var castling = function (step) {
			var queenRookRule = {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: step(4),
					_1: _darrensiegel$elm_chess_client$Data_Query$isNewRook
				},
				_1: {ctor: '[]'}
			};
			var kingRookRule = {
			...
			var rookReady = clear(kingRookRule) || clear(queenRookRule);
			var castlepath = {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: step(1),
					_1: _darrensiegel$elm_chess_client$Data_Query$isVacant
				},
				_1: {
					ctor: '::',
					_0: {
			...
			return A2(
				...
				A2(_elm_lang$core$List$map, _darrensiegel$elm_chess_client$Depo_Lib$fst, castlepath));
		};
		var sides = {
			ctor: '::',
			_0: _darrensiegel$elm_chess_client$Depo_Moves$right,
		...
		return A2(
			_darrensiegel$elm_chess_client$Depo_Lib_ops['??'],
			_darrensiegel$elm_chess_client$Data_Query$stationary(king),
			A2(_elm_lang$core$List$concatMap, castling, sides));
	});
var _darrensiegel$elm_chess_client$Model_Rules$enPassant = F2(
	function (pawn, board) {
		var passantRules = function (move) {
			return {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: move(1),
					_1: _darrensiegel$elm_chess_client$Data_Query$isUntouched
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: move(1),
						_1: _darrensiegel$elm_chess_client$Data_Query$hasPawn
					},
					_1: {ctor: '[]'}
				}
			};
		...
		var checkPawn = A2(
			_elm_lang$core$List$foldl,
			A2(_darrensiegel$elm_chess_client$Model_Rules$validate, pawn, board),
			{ctor: '[]'});
		var passing = F2(
			function (dir, square) {
				return _darrensiegel$elm_chess_client$Data_Query$isVacant(square) ? _elm_lang$core$Native_Utils.eq(
					function (_p17) {
						...
						passantRules(dir)),
					_elm_lang$core$List$length(
						passantRules(_elm_lang$core$Basics$identity))) : false;
			});
		var step = _darrensiegel$elm_chess_client$Depo_Moves$forwardMove(pawn);
		var rules = {
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: function (_p18) {
					return A2(
						_darrensiegel$elm_chess_client$Depo_Moves$left,
						1,
						A2(step, 1, _p18));
				},
				_1: passing(_darrensiegel$elm_chess_client$Depo_Moves$left)
			},
			_1: {
				ctor: '::',
				_0: {
					...
					_0: function (_p19) {
						return A2(
							_darrensiegel$elm_chess_client$Depo_Moves$right,
							1,
							A2(step, 1, _p19));
					},
					_1: passing(_darrensiegel$elm_chess_client$Depo_Moves$right)
				},
				_1: {ctor: '[]'}
			}
		};
		return checkPawn(rules);
	});
var _darrensiegel$elm_chess_client$Model_Rules$isEnPassant = F2(
	function (piece, board) {
		return _darrensiegel$elm_chess_client$Data_Query$passanting(piece) && function (_p20) {
			return !_elm_lang$core$List$isEmpty(_p20);
		}(
			A2(_darrensiegel$elm_chess_client$Model_Rules$enPassant, piece, board));
	});
var _darrensiegel$elm_chess_client$Model_Rules$pawnMoves = F2(
	function (pawn, board) {
		var checkPawn = function (fn) {
			return A2(fn, pawn, board);
		};
		var checkRules = A2(
			_elm_lang$core$List$foldl,
			checkPawn(_darrensiegel$elm_chess_client$Model_Rules$validate),
			{ctor: '[]'});
		var step = _darrensiegel$elm_chess_client$Depo_Moves$forwardMove(pawn);
		var rules = A2(
			_elm_lang$core$Basics_ops['++'],
			_darrensiegel$elm_chess_client$Model_Rules$starting(pawn) ? {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: step(2),
			...
			} : {ctor: '[]'},
			{
				...
				_1: {
					...
					_0: {
						...
						_1: _darrensiegel$elm_chess_client$Data_Query$isOccupied
					},
					_1: {
						ctor: '::',
						_0: {
...
var _darrensiegel$elm_chess_client$Model_Rules$pieceMoves = F2(
	function (piece, board) {
		var find = function (f) {
			return A2(f, piece, board);
		};
		var linear = find(_darrensiegel$elm_chess_client$Depo_Moves$linearMove);
		var moves = function (role) {
			var _p24 = role;
			switch (_p24.ctor) {
				case 'Pawn':
					return find(_darrensiegel$elm_chess_client$Model_Rules$pawnMoves);
				case 'Bishop':
					return linear(_darrensiegel$elm_chess_client$Depo_Moves$diagonals);
				case 'Rook':
					return linear(_darrensiegel$elm_chess_client$Depo_Moves$straights);
				case 'Queen':
					return linear(_darrensiegel$elm_chess_client$Depo_Moves$asterisk);
				case 'Knight':
					return {
						ctor: '::',
						_0: function (_p25) {
							return A2(
								_darrensiegel$elm_chess_client$Depo_Moves$right,
								1,
								A2(_darrensiegel$elm_chess_client$Depo_Moves$up, 2, _p25));
						},
						_1: {
							ctor: '::',
							_0: function (_p26) {
								return A2(
									_darrensiegel$elm_chess_client$Depo_Moves$left,
									1,
									A2(_darrensiegel$elm_chess_client$Depo_Moves$up, 2, _p26));
							},
							_1: {
								ctor: '::',
								_0: function (_p27) {
									return A2(
										_darrensiegel$elm_chess_client$Depo_Moves$left,
										1,
										A2(_darrensiegel$elm_chess_client$Depo_Moves$down, 2, _p27));
								},
								_1: {
									ctor: '::',
									_0: function (_p28) {
										return A2(
											_darrensiegel$elm_chess_client$Depo_Moves$right,
											1,
											A2(_darrensiegel$elm_chess_client$Depo_Moves$down, 2, _p28));
									},
									_1: {
										ctor: '::',
										_0: function (_p29) {
											return A2(
												_darrensiegel$elm_chess_client$Depo_Moves$up,
												1,
												A2(_darrensiegel$elm_chess_client$Depo_Moves$left, 2, _p29));
										},
										_1: {
											ctor: '::',
											_0: function (_p30) {
												return A2(
													_darrensiegel$elm_chess_client$Depo_Moves$down,
													1,
													A2(_darrensiegel$elm_chess_client$Depo_Moves$left, 2, _p30));
											},
											_1: {
												ctor: '::',
												_0: function (_p31) {
													return A2(
														_darrensiegel$elm_chess_client$Depo_Moves$up,
														1,
														A2(_darrensiegel$elm_chess_client$Depo_Moves$right, 2, _p31));
												},
												_1: {
													ctor: '::',
													_0: function (_p32) {
														return A2(
															_darrensiegel$elm_chess_client$Depo_Moves$down,
															1,
															A2(_darrensiegel$elm_chess_client$Depo_Moves$right, 2, _p32));
													},
													_1: {ctor: '[]'}
												}
											}
				...
				case 'King':
					return A2(
						...
						{
							ctor: '::',
							_0: _darrensiegel$elm_chess_client$Depo_Moves$up(1),
							_1: {
								ctor: '::',
								_0: _darrensiegel$elm_chess_client$Depo_Moves$down(1),
								_1: {
									ctor: '::',
									_0: _darrensiegel$elm_chess_client$Depo_Moves$left(1),
									_1: {
										ctor: '::',
										_0: _darrensiegel$elm_chess_client$Depo_Moves$right(1),
										_1: {
											ctor: '::',
											_0: function (_p33) {
												return A2(
													_darrensiegel$elm_chess_client$Depo_Moves$left,
													1,
													A2(_darrensiegel$elm_chess_client$Depo_Moves$up, 1, _p33));
											},
											_1: {
												ctor: '::',
												_0: function (_p34) {
													return A2(
														_darrensiegel$elm_chess_client$Depo_Moves$right,
														1,
														A2(_darrensiegel$elm_chess_client$Depo_Moves$up, 1, _p34));
												},
												_1: {
													ctor: '::',
													_0: function (_p35) {
														return A2(
															_darrensiegel$elm_chess_client$Depo_Moves$left,
															1,
															A2(_darrensiegel$elm_chess_client$Depo_Moves$down, 1, _p35));
													},
													_1: {
														ctor: '::',
														_0: function (_p36) {
															return A2(
																_darrensiegel$elm_chess_client$Depo_Moves$right,
																1,
																A2(_darrensiegel$elm_chess_client$Depo_Moves$down, 1, _p36));
														},
														_1: {ctor: '[]'}
													}
												}
						...
						find(_darrensiegel$elm_chess_client$Model_Rules$castle));
				default:
					return {ctor: '[]'};
			}
		};
		return A3(
			_darrensiegel$elm_chess_client$Model_Rules$distinct,
			piece,
			board,
			moves(piece.role));
	});

var _darrensiegel$elm_chess_client$Model_Board$ifEnPassant = F3(
	function (fn, mv, bd) {
		return mv.enPassant ? A2(fn, mv, bd) : bd;
	});
var _darrensiegel$elm_chess_client$Model_Board$whenCheck = F3(
	function (fn, mv, bd) {
		var enemyKingLoc = A2(
			_elm_community$maybe_extra$Maybe_Extra_ops['?'],
			_elm_lang$core$List$head(
				A2(
					...
					function (sq) {
						...
						if (_p0.ctor === 'Just') {
							...
							if (_p1.ctor === 'King') {
								return _elm_lang$core$Native_Utils.eq(
									_p2.color,
									_darrensiegel$elm_chess_client$Data_Query$opponent(mv.piece.color)) ? _elm_lang$core$Maybe$Just(sq.point) : _elm_lang$core$Maybe$Nothing;
							} else {
								return _elm_lang$core$Maybe$Nothing;
							}
						} else {
					...
					_chendrix$elm_matrix$Matrix$flatten(bd))),
			_darrensiegel$elm_chess_client$Data_Pure$joker.point);
		return mv.check ? A2(fn, enemyKingLoc, bd) : bd;
	});
var _darrensiegel$elm_chess_client$Model_Board$withPinned = F3(
	function (fn, mv, bd) {
		var _p3 = mv.pin;
		if (_p3.ctor === 'Just') {
			return A2(fn, _p3._0, bd);
		} else {
			return bd;
		}
	});
var _darrensiegel$elm_chess_client$Model_Board$whenCapturing = F3(
	function (fn, mv, bd) {
		var _p4 = mv.capture;
		if (_p4.ctor === 'Just') {
			return A2(fn, _p4._0, bd);
		} else {
			return bd;
		}
	});
var _darrensiegel$elm_chess_client$Model_Board$whenCastling = F3(
	function (fn, mv, bd) {
		return _darrensiegel$elm_chess_client$Model_Rules$isCastling(mv.piece) ? A2(fn, mv, bd) : bd;
	});
var _darrensiegel$elm_chess_client$Model_Board$withMovingPieces = F2(
	function (fn, square) {
		var _p5 = square.piece;
		if (_p5.ctor === 'Just') {
			var _p6 = _p5._0;
			return (_elm_lang$core$Native_Utils.cmp(
				_elm_lang$core$List$length(_p6.path),
				1) > 0) ? _elm_lang$core$Native_Utils.update(
				square,
				{
					piece: _elm_lang$core$Maybe$Just(
						fn(_p6))
...
var _darrensiegel$elm_chess_client$Model_Board$ticks = function (board) {
	var tickPiece = function (_p7) {
		return _darrensiegel$elm_chess_client$Model_Board$withMovingPieces(
			function (p) {
				return _elm_lang$core$Native_Utils.update(
					p,
					{tick: p.tick + 1});
	...
	return A2(_chendrix$elm_matrix$Matrix$mapWithLocation, tickPiece, board);
};
var _darrensiegel$elm_chess_client$Model_Board$withActiveSquare = F2(
	function (fn, square) {
		return square.active ? fn(square) : square;
	});
var _darrensiegel$elm_chess_client$Model_Board$withValidSquare = F2(
	function (fn, square) {
		return square.valid ? fn(square) : square;
	});
var _darrensiegel$elm_chess_client$Model_Board$translatePiece = F2(
	function (target, piece) {
		var different = F2(
			function (x, y) {
				return !_elm_lang$core$Native_Utils.eq(x, y);
			})(target);
		var isDifferent = function (p) {
			return A2(
				_elm_community$maybe_extra$Maybe_Extra_ops['?'],
				A2(_elm_lang$core$Maybe$map, different, p),
				false);
		};
		var lastPath = _darrensiegel$elm_chess_client$Depo_Lib$last(piece.path);
		var destination = _darrensiegel$elm_chess_client$Data_Cast$toBoardPosition(target);
		return _elm_lang$core$Native_Utils.update(
			piece,
			{
				point: target,
				drag: destination,
				path: isDifferent(lastPath) ? A2(
					_elm_lang$core$Basics_ops['++'],
					piece.path,
					{
						ctor: '::',
...
var _darrensiegel$elm_chess_client$Model_Board$occupySquare = F2(
	function (pc, sq) {
		return _elm_lang$core$Native_Utils.update(
			sq,
			{
				piece: _elm_lang$core$Maybe$Just(pc)
			});
	});
var _darrensiegel$elm_chess_client$Model_Board$add = F2(
	function (piece, board) {
		var target = piece.point;
		var newPiece = A2(_darrensiegel$elm_chess_client$Model_Board$translatePiece, target, piece);
		return A3(
			_chendrix$elm_matrix$Matrix$update,
			target,
			_darrensiegel$elm_chess_client$Model_Board$withValidSquare(
				_darrensiegel$elm_chess_client$Model_Board$occupySquare(newPiece)),
			board);
	});
var _darrensiegel$elm_chess_client$Model_Board$jump = F2(
	function (piece, board) {
		var target = piece.point;
		var newPiece = A2(_darrensiegel$elm_chess_client$Model_Board$translatePiece, target, piece);
		return A3(
...
var _darrensiegel$elm_chess_client$Model_Board$revert = F2(
	function (piece, board) {
		var putback = function (target) {
			return _darrensiegel$elm_chess_client$Model_Board$withActiveSquare(
				_darrensiegel$elm_chess_client$Model_Board$occupySquare(
					A2(_darrensiegel$elm_chess_client$Model_Board$translatePiece, target, piece)));
		};
		return A2(_chendrix$elm_matrix$Matrix$mapWithLocation, putback, board);
	});
var _darrensiegel$elm_chess_client$Model_Board$validateSquare = function (sq) {
	return _elm_lang$core$Native_Utils.update(
		sq,
		{valid: true});
};
var _darrensiegel$elm_chess_client$Model_Board$analyze = F2(
	function (piece, board) {
		var validateSquares = F2(
			function (origin, bd) {
				return A3(_chendrix$elm_matrix$Matrix$update, origin, _darrensiegel$elm_chess_client$Model_Board$validateSquare, bd);
			});
		var translations = A2(_darrensiegel$elm_chess_client$Model_Rules$pieceMoves, piece, board);
		...
		var movelist = A2(
			...
			A2(
				...
				origin),
			translations);
		var locations = (_elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$List$length(translations),
			0) > 0) ? {ctor: '::', _0: origin, _1: movelist} : {ctor: '[]'};
		return A3(_elm_lang$core$List$foldl, validateSquares, board, locations);
	});
var _darrensiegel$elm_chess_client$Model_Board$emptySquare = function (sq) {
	return _elm_lang$core$Native_Utils.update(
		sq,
		{piece: _elm_lang$core$Maybe$Nothing});
};
var _darrensiegel$elm_chess_client$Model_Board$activateSquare = function (sq) {
	return _elm_lang$core$Native_Utils.update(
		sq,
		{active: true});
};
var _darrensiegel$elm_chess_client$Model_Board$remove = F2(
	function (piece, board) {
		var lastLocation = A2(
			_elm_community$maybe_extra$Maybe_Extra_ops['?'],
			_darrensiegel$elm_chess_client$Depo_Lib$last(piece.path),
			piece.point);
		return A3(
			_chendrix$elm_matrix$Matrix$update,
			lastLocation,
			function (_p8) {
				return _darrensiegel$elm_chess_client$Model_Board$activateSquare(
					_darrensiegel$elm_chess_client$Model_Board$emptySquare(_p8));
			},
			board);
	});
var _darrensiegel$elm_chess_client$Model_Board$castleRook = F2(
	function (move, board) {
		var _p9 = move.end;
		var y2 = _p9._0;
		var x2 = _p9._1;
		...
		var y1 = _p10._0;
		var x1 = _p10._1;
		var castleDiff = x2 - x1;
		var rookMove = _darrensiegel$elm_chess_client$Depo_Lib$isPositive(castleDiff) ? {
			ctor: '_Tuple2',
			_0: A2(_chendrix$elm_matrix$Matrix$loc, y1, 7),
			_1: A2(_chendrix$elm_matrix$Matrix$loc, y1, 5)
		} : {
			ctor: '_Tuple2',
			_0: A2(_chendrix$elm_matrix$Matrix$loc, y1, 0),
			_1: A2(_chendrix$elm_matrix$Matrix$loc, y1, 3)
		};
		var rook = A2(
			_elm_community$maybe_extra$Maybe_Extra_ops['?'],
			A2(
				...
				A2(
					_chendrix$elm_matrix$Matrix$get,
					_darrensiegel$elm_chess_client$Depo_Lib$fst(rookMove),
					board),
		...
		return A2(
			...
			_elm_lang$core$Native_Utils.update(
				rook,
				{
					point: _darrensiegel$elm_chess_client$Depo_Lib$snd(rookMove)
				}),
			A2(_darrensiegel$elm_chess_client$Model_Board$remove, rook, board));
	});
var _darrensiegel$elm_chess_client$Model_Board$clearSquare = function (sq) {
	return _elm_lang$core$Native_Utils.update(
		sq,
		{valid: false, active: false});
};
var _darrensiegel$elm_chess_client$Model_Board$clear = function (board) {
	return A2(_chendrix$elm_matrix$Matrix$map, _darrensiegel$elm_chess_client$Model_Board$clearSquare, board);
};
var _darrensiegel$elm_chess_client$Model_Board$checkKing = F2(
	function (pt, board) {
		return A3(
			_chendrix$elm_matrix$Matrix$update,
			pt,
...
var _darrensiegel$elm_chess_client$Model_Board$pinPiece = F2(
	function (pc, bd) {
		return A3(
			_chendrix$elm_matrix$Matrix$update,
			pc.point,
...
var _darrensiegel$elm_chess_client$Model_Board$drop = F2(
	function (piece, board) {
		return function (_p14) {
			return _darrensiegel$elm_chess_client$Model_Board$clear(
				_darrensiegel$elm_chess_client$Model_Board$ticks(_p14));
		}(
			A2(_darrensiegel$elm_chess_client$Model_Board$add, piece, board));
	});
var _darrensiegel$elm_chess_client$Model_Board$grab = F2(
	function (piece, board) {
		return A2(
			_darrensiegel$elm_chess_client$Model_Board$remove,
			piece,
	...
	function (board, select) {
		var ghost = function (s) {
			return _elm_lang$core$Native_Utils.update(
				s,
				{
					drag: _darrensiegel$elm_chess_client$Data_Cast$toBoardPosition(select.focus),
					point: select.focus
				});
		}(select.piece);
		...
		var destination = _darrensiegel$elm_chess_client$Data_Cast$toBoardLocation(select.piece.drag);
		var target = A2(
			_elm_community$maybe_extra$Maybe_Extra_ops['?'],
			...
			var simBoard = A3(
				...
				function (sq) {
					return _elm_lang$core$Native_Utils.update(
						sq,
						{
							piece: _elm_lang$core$Maybe$Just(piece)
						});
				},
				board);
			var king = A2(
					...
					A2(
						...
						function (sq) {
							...
							if (_p1.ctor === 'Just') {
								...
								var _p2 = _p3.role;
								if (_p2.ctor === 'King') {
									return _elm_lang$core$Native_Utils.eq(_p3.color, piece.color) ? _elm_lang$core$Maybe$Just(_p3) : _elm_lang$core$Maybe$Nothing;
								} else {
									return _elm_lang$core$Maybe$Nothing;
								}
							} else {
				...
				_darrensiegel$elm_chess_client$Data_Pure$joker);
			return (_elm_lang$core$Native_Utils.eq(piece.role, _darrensiegel$elm_chess_client$Data_Type$King) && piece.check) ? function (_p4) {
				return A2(
					F2(
						function (x, y) {
							return _elm_lang$core$Native_Utils.eq(x, y);
				...
				A2(_darrensiegel$elm_chess_client$Model_Rules$findThreat, piece, board)) : (king.check ? function (_p5) {
				return A2(
					F2(
						function (x, y) {
							return _elm_lang$core$Native_Utils.eq(x, y);
				...
				A2(_darrensiegel$elm_chess_client$Model_Rules$findThreat, king, simBoard)) : true);
		}();
		var pinTarget = function () {
			var targetSquare = _elm_lang$core$List$head(
				A3(_darrensiegel$elm_chess_client$Model_Rules$withPinner, piece, board, _darrensiegel$elm_chess_client$Model_Rules$findNextOpponent));
			var target = _elm_community$maybe_extra$Maybe_Extra$join(
				A2(
					_darrensiegel$elm_chess_client$Depo_Lib_ops['?>'],
					targetSquare,
					function (_p6) {
			...
			return A2(_elm_community$maybe_extra$Maybe_Extra_ops['?'], target, _darrensiegel$elm_chess_client$Data_Pure$vacantSquare).piece;
		}();
		var isCheck = A2(
			_elm_lang$core$List$any,
			_elm_lang$core$Basics$identity,
			A2(
				...
				function (tr) {
					...
					if (_p7.ctor === 'Just') {
						...
						var _p8 = _p9.role;
						if (_p8.ctor === 'King') {
							return !_elm_lang$core$Native_Utils.eq(_p9.color, piece.color);
						} else {
							return false;
						}
					} else {
				...
				A2(_darrensiegel$elm_chess_client$Model_Rules$pieceMoves, piece, board)));
		var pinPiece = (!isCheck) ? _elm_community$maybe_extra$Maybe_Extra$join(
			A2(
				_darrensiegel$elm_chess_client$Depo_Lib_ops['?>'],
				pinTarget,
				function (p) {
					return (!_darrensiegel$elm_chess_client$Data_Query$isKing(p)) ? _elm_lang$core$Maybe$Just(p) : _elm_lang$core$Maybe$Nothing;
				})) : _elm_lang$core$Maybe$Nothing;
		var captured = function () {
			if (isPassant) {
				var captureLocation = A3(_darrensiegel$elm_chess_client$Depo_Moves$backwardMove, piece, 1, destination);
		...
		return ((!_elm_lang$core$Native_Utils.eq(destination, select.focus)) && (target.valid && ((!piece.lock) && checkCleared))) ? _darrensiegel$elm_chess_client$Data_Type$End(
			A7(_darrensiegel$elm_chess_client$Data_Type$Move, select.focus, destination, piece, captured, pinPiece, isCheck, isPassant)) : _darrensiegel$elm_chess_client$Data_Type$Playing(select);
	});
var _darrensiegel$elm_chess_client$State_Action$clickMove = F4(
	function (player, board, pos, loc) {
		var _p10 = player.action;
		if (_p10.ctor === 'Playing') {
			var _p11 = _p10._0;
			var selPiece = _p11.piece;
			var sim = _elm_lang$core$Native_Utils.update(
				_p11,
				{
					piece: _elm_lang$core$Native_Utils.update(
						selPiece,
						{drag: pos, point: loc})
				});
			return A2(_darrensiegel$elm_chess_client$State_Action$endMove, board, sim);
		} else {
			return _darrensiegel$elm_chess_client$Data_Type$Idle;
		}
	});
var _darrensiegel$elm_chess_client$State_Action$whileMoving = F2(
	function (action, change) {
		var _p12 = action;
		if (_p12.ctor === 'Moving') {
			return change(_p12._0);
		} else {
			return _darrensiegel$elm_chess_client$Data_Type$Idle;
		}
	});
var _darrensiegel$elm_chess_client$State_Action$updateMoving = F2(
	function (ps, _p13) {
		var _p14 = _p13;
		return _darrensiegel$elm_chess_client$Data_Type$Moving(
			A2(
				_darrensiegel$elm_chess_client$Data_Type$Selection,
				_p14.focus,
				_elm_lang$core$Native_Utils.update(
					_p14.piece,
					{drag: ps})));
	});
var _darrensiegel$elm_chess_client$State_Action$startMoving = F2(
	function (ps, _p15) {
		var _p16 = _p15;
		return _darrensiegel$elm_chess_client$Data_Type$Moving(
			A2(
...
var _darrensiegel$elm_chess_client$State_Action$select = F2(
	function (drag, board) {
		var selectPiece = function (square) {
			var selectP = function (piece) {
				return (!piece.lock) ? _elm_lang$core$Maybe$Just(
					A2(_darrensiegel$elm_chess_client$Data_Type$Selection, square.point, piece)) : _elm_lang$core$Maybe$Nothing;
			};
			return _elm_community$maybe_extra$Maybe_Extra$join(
				A2(_darrensiegel$elm_chess_client$Depo_Lib_ops['?>'], square.piece, selectP));
		};
		var locate = function (xy) {
			return A2(
				_chendrix$elm_matrix$Matrix$get,
				_darrensiegel$elm_chess_client$Data_Cast$toBoardLocation(xy),
				board);
		};
		var selecting = function (_p17) {
			return _elm_community$maybe_extra$Maybe_Extra$join(
				A2(
					F2(
						function (x, y) {
...
var _darrensiegel$elm_chess_client$State_Game$update = F2(
	function (event, _p0) {
		...
		var player = _darrensiegel$elm_chess_client$Depo_Lib$fst(_p17);
		var action_ = function () {
			var _p3 = event;
			switch (_p3.ctor) {
				case 'Click':
					var _p5 = _p3._0;
					var clickTo = A2(_darrensiegel$elm_chess_client$State_Action$clickMove, player, _p16.board);
					var target = _darrensiegel$elm_chess_client$Data_Cast$toBoardLocation(_p5);
					var _p4 = selection;
					if (_p4.ctor === 'Just') {
						return A2(_darrensiegel$elm_chess_client$Model_Rules$capturing, player, selection) ? A2(clickTo, _p5, target) : A2(_darrensiegel$elm_chess_client$State_Action$startMoving, _p5, _p4._0);
					} else {
						return A2(clickTo, _p5, target);
					}
				case 'Drag':
					return A2(
						_darrensiegel$elm_chess_client$State_Action$whileMoving,
						player.action,
						_darrensiegel$elm_chess_client$State_Action$updateMoving(_p3._0));
				case 'Drop':
					return A2(
						_darrensiegel$elm_chess_client$State_Action$whileMoving,
						player.action,
		...
		var players_ = function () {
			var _p8 = action_;
			if (_p8.ctor === 'End') {
				return {
					ctor: '_Tuple2',
					_0: _darrensiegel$elm_chess_client$Depo_Lib$snd(_p17),
					_1: player_
				};
			} else {
				return {
					ctor: '_Tuple2',
					_0: player_,
					_1: _darrensiegel$elm_chess_client$Depo_Lib$snd(_p17)
				};
			}
		}();
		var ui_ = function () {
			var currentPlayer = _darrensiegel$elm_chess_client$Depo_Lib$fst(players_);
		...
		var board_ = function () {
			...
			switch (_p10.ctor) {
				case 'Playing':
					return A2(_darrensiegel$elm_chess_client$Model_Board$revert, _p10._0.piece, _p16.board);
				case 'Moving':
					var piece = _p10._0.piece;
					var preform = function (fn) {
						return A2(fn, piece, _p16.board);
					};
					var _p11 = player.action;
					if (_p11.ctor === 'Moving') {
						return preform(_darrensiegel$elm_chess_client$Model_Board$analyze);
					} else {
						return A2(
							_darrensiegel$elm_chess_client$Model_Board$analyze,
							piece,
							preform(_darrensiegel$elm_chess_client$Model_Board$grab));
					}
				case 'End':
					var _p13 = _p10._0;
					var eat = function (captured) {
						return _darrensiegel$elm_chess_client$Data_Query$isClick(event) ? _darrensiegel$elm_chess_client$Model_Board$grab(captured) : _elm_lang$core$Basics$identity;
					};
					var place = function (piece) {
						return function (_p12) {
							return (_darrensiegel$elm_chess_client$Data_Query$isClick(event) ? eat(piece) : _elm_lang$core$Basics$identity)(
								A2(_darrensiegel$elm_chess_client$Model_Board$drop, piece, _p12));
						};
					};
					return A3(
						_darrensiegel$elm_chess_client$Model_Board$whenCheck,
						_darrensiegel$elm_chess_client$Model_Board$checkKing,
						_p13,
						(_p13.enPassant ? A2(_darrensiegel$elm_chess_client$Model_Board$whenCapturing, eat, _p13) : _elm_lang$core$Basics$identity)(
							A3(
								_darrensiegel$elm_chess_client$Model_Board$withPinned,
								_darrensiegel$elm_chess_client$Model_Board$pinPiece,
								_p13,
								A3(
									_darrensiegel$elm_chess_client$Model_Board$whenCastling,
									_darrensiegel$elm_chess_client$Model_Board$castleRook,
									_p13,
									A2(place, _p13.piece, _p16.board)))));
				default:
					return _p16.board;
			}
		}();
		var game = function (mat_) {
			return A3(
				_darrensiegel$elm_chess_client$Data_Type$Game,
				mat_,
				A2(_darrensiegel$elm_chess_client$Data_Type$Chess, board_, history_),
				players_);
		};
		var _p14 = event;
		if (_p14.ctor === 'GUI') {
			var _p15 = A3(_debois$elm_mdl$Material$update, _darrensiegel$elm_chess_client$Data_Type$GUI, _p14._0, ui_);
			var mat_ = _p15._0;
			var sub_ = _p15._1;
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
...
var _darrensiegel$elm_chess_client$State_Game$subscribe = function (_p19) {
	...
	var $default = {
		...
		_0: _elm_lang$keyboard$Keyboard$presses(
			_darrensiegel$elm_chess_client$State_Game$toggleDebug(_p22.debug)),
		_1: {
			ctor: '::',
			_0: A2(_debois$elm_mdl$Material_Layout$subs, _darrensiegel$elm_chess_client$Data_Type$GUI, _p22.mdl),
			_1: {ctor: '[]'}
		}
	};
	var _p21 = _darrensiegel$elm_chess_client$Depo_Lib$fst(_p20.players).action;
	if (_p21.ctor === 'Moving') {
		return _elm_lang$core$Platform_Sub$batch(
			A2(
				_elm_lang$core$Basics_ops['++'],
...
var _darrensiegel$elm_chess_client$Model_History$prevPlayerColor = function (ms) {
	return A2(
		_elm_community$maybe_extra$Maybe_Extra_ops['?'],
		A2(
			_elm_lang$core$Maybe$map,
			...
			_elm_lang$core$List$head(ms)),
		_darrensiegel$elm_chess_client$Data_Type$Black);
};
var _darrensiegel$elm_chess_client$Model_History$getPlayerByColor = F3(
	function (color, history, _p0) {
		var _p1 = _p0;
		var _p3 = _p1._0;
		...
		return (_elm_lang$core$Native_Utils.eq(
			_darrensiegel$elm_chess_client$Model_History$prevPlayerColor(history),
			otherColor) && (!_elm_lang$core$Native_Utils.eq(_p3.color, otherColor))) ? _p3 : _p1._1;
	});
var _darrensiegel$elm_chess_client$Model_History$getWhite = _darrensiegel$elm_chess_client$Model_History$getPlayerByColor(_darrensiegel$elm_chess_client$Data_Type$White);
var _darrensiegel$elm_chess_client$Model_History$getBlack = _darrensiegel$elm_chess_client$Model_History$getPlayerByColor(_darrensiegel$elm_chess_client$Data_Type$Black);
var _darrensiegel$elm_chess_client$Model_History$toTuples = function (moves) {
	var tuckFold = function (_p4) {
		var _p5 = _p4;
		var _p8 = _p5._1;
		var _p6 = _p5._0;
		if (_p6.ctor === 'Just') {
			...
			if (_p11.ctor === 'Just') {
				return {
					...
					_1: A2(
						...
						{
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: _p11._0, _1: mv},
							_1: {ctor: '[]'}
						})
				};
			} else {
...
var _darrensiegel$elm_chess_client$Model_History$fullMove = F2(
	function (i, _p13) {
		var _p14 = _p13;
		var _p16 = _p14._0;
		var _p15 = _p14._1;
		return (!_elm_lang$core$Native_Utils.eq(_p16, _p15)) ? A2(
			...
			A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					_p16,
					A2(_elm_lang$core$Basics_ops['++'], ' ', _p15)))) : A2(
			_elm_lang$core$Basics_ops['++'],
			_elm_lang$core$Basics$toString(i + 1),
...
var _darrensiegel$elm_chess_client$Model_History$debugHistory = function (history) {
	var formatPiece = function (p) {
		return A2(
			...
			A2(
				...
				' ',
				{
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$core$Basics$toString(p.point),
							_1: {ctor: '[]'}
						}
					}
				}),
			A2(
				_elm_lang$core$Basics_ops['++'],
				'\ntick: ',
				_elm_lang$core$Basics$toString(p.tick)));
	};
	...
	return A2(
		...
		A2(
			...
			'\ncapture:\n',
			debugPiece(
				A2(_elm_community$maybe_extra$Maybe_Extra_ops['?'], lastMove.capture, _darrensiegel$elm_chess_client$Data_Pure$joker))));
};
var _darrensiegel$elm_chess_client$Model_History$formatHistory = function (_p18) {
	return A2(
		_elm_lang$core$List$map,
		_elm_lang$core$Basics$uncurry(_darrensiegel$elm_chess_client$Model_History$fullMove),
		A2(
			_elm_lang$core$List$indexedMap,
			F2(
				function (v0, v1) {
			...
			A2(
				...
				function (_p19) {
					return A2(
						_elm_lang$core$Tuple$mapSecond,
						_darrensiegel$elm_chess_client$Depo_SAN$toSAN,
						A2(_elm_lang$core$Tuple$mapFirst, _darrensiegel$elm_chess_client$Depo_SAN$toSAN, _p19));
				},
				_darrensiegel$elm_chess_client$Model_History$toTuples(
					_elm_lang$core$List$reverse(_p18)))));
};

var _darrensiegel$elm_chess_client$View_Asset$svgTag = function (s) {
	var _p0 = s;
	switch (_p0) {
		case 'w_p':
		...
		case 'w_b':
			return '<svg xmlns=\"http://www.w3.org/2000/svg\" version=\"1.1\" width=\"45\" height=\"45\">  <g style=\"opacity:1; fill:none; fill-rule:evenodd; fill-opacity:1; stroke:#000000; stroke-width:1.5; stroke-linecap:round; stroke-linejoin:round; stroke-miterlimit:4; stroke-dasharray:none; stroke-opacity:1;\">    <g style=\"fill:#ffffff; stroke:#000000; stroke-linecap:butt;\">       <path d=\"M 9,36 C 12.39,35.03 19.11,36.43 22.5,34 C 25.89,36.43 32.61,35.03 36,36 C 36,36 37.65,36.54 39,38 C 38.32,38.97 37.35,38.99 36,38.5 C 32.61,37.53 25.89,38.96 22.5,37.5 C 19.11,38.96 12.39,37.53 9,38.5 C 7.646,38.99 6.677,38.97 6,38 C 7.354,36.06 9,36 9,36 z\"/>      <path d=\"M 15,32 C 17.5,34.5 27.5,34.5 30,32 C 30.5,30.5 30,30 30,30 C 30,27.5 27.5,26 27.5,26 C 33,24.5 33.5,14.5 22.5,10.5 C 11.5,14.5 12,24.5 17.5,26 C 17.5,26 15,27.5 15,30 C 15,30 14.5,30.5 15,32 z\"/>      <path d=\"M 25 8 A 2.5 2.5 0 1 1  20,8 A 2.5 2.5 0 1 1  25 8 z\"/>    </g>    <path d=\"M 17.5,26 L 27.5,26 M 15,30 L 30,30 M 22.5,15.5 L 22.5,20.5 M 20,18 L 25,18\" style=\"fill:none; stroke:#000000; stroke-linejoin:miter;\"/>  </g></svg>';
		case 'w_n':
			return '<svg xmlns=\"http://www.w3.org/2000/svg\" version=\"1.1\" width=\"45\" height=\"45\">  <g style=\"opacity:1; fill:none; fill-opacity:1; fill-rule:evenodd; stroke:#000000; stroke-width:1.5; stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4; stroke-dasharray:none; stroke-opacity:1;\">    <path d=\"M 22,10 C 32.5,11 38.5,18 38,39 L 15,39 C 15,30 25,32.5 23,18\" style=\"fill:#ffffff; stroke:#000000;\"/>    <path d=\"M 24,18 C 24.38,20.91 18.45,25.37 16,27 C 13,29 13.18,31.34 11,31 C 9.958,30.06 12.41,27.96 11,28 C 10,28 11.19,29.23 10,30 C 9,30 5.997,31 6,26 C 6,24 12,14 12,14 C 12,14 13.89,12.1 14,10.5 C 13.27,9.506 13.5,8.5 13.5,7.5 C 14.5,6.5 16.5,10 16.5,10 L 18.5,10 C 18.5,10 19.28,8.008 21,7 C 22,7 22,10 22,10\" style=\"fill:#ffffff; stroke:#000000;\"/>    <path d=\"M 9.5 25.5 A 0.5 0.5 0 1 1 8.5,25.5 A 0.5 0.5 0 1 1 9.5 25.5 z\" style=\"fill:#000000; stroke:#000000;\"/>    <path d=\"M 15 15.5 A 0.5 1.5 0 1 1  14,15.5 A 0.5 1.5 0 1 1  15 15.5 z\" transform=\"matrix(0.866,0.5,-0.5,0.866,9.693,-5.173)\" style=\"fill:#000000; stroke:#000000;\"/>  </g></svg>';
		case 'w_q':
			return '<svg xmlns=\"http://www.w3.org/2000/svg\" version=\"1.1\" width=\"45\" height=\"45\">  <g style=\"opacity:1; fill:#ffffff; fill-opacity:1; fill-rule:evenodd; stroke:#000000; stroke-width:1.5; stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4; stroke-dasharray:none; stroke-opacity:1;\">    <path d=\"M 9 13 A 2 2 0 1 1  5,13 A 2 2 0 1 1  9 13 z\" transform=\"translate(-1,-1)\"/>    <path d=\"M 9 13 A 2 2 0 1 1  5,13 A 2 2 0 1 1  9 13 z\" transform=\"translate(15.5,-5.5)\"/>    <path d=\"M 9 13 A 2 2 0 1 1  5,13 A 2 2 0 1 1  9 13 z\" transform=\"translate(32,-1)\"/>    <path d=\"M 9 13 A 2 2 0 1 1  5,13 A 2 2 0 1 1  9 13 z\" transform=\"translate(7,-4.5)\"/>    <path d=\"M 9 13 A 2 2 0 1 1  5,13 A 2 2 0 1 1  9 13 z\" transform=\"translate(24,-4)\"/>    <path d=\"M 9,26 C 17.5,24.5 30,24.5 36,26 L 38,14 L 31,25 L 31,11 L 25.5,24.5 L 22.5,9.5 L 19.5,24.5 L 14,10.5 L 14,25 L 7,14 L 9,26 z \" style=\"stroke-linecap:butt;\"/>    <path d=\"M 9,26 C 9,28 10.5,28 11.5,30 C 12.5,31.5 12.5,31 12,33.5 C 10.5,34.5 10.5,36 10.5,36 C 9,37.5 11,38.5 11,38.5 C 17.5,39.5 27.5,39.5 34,38.5 C 34,38.5 35.5,37.5 34,36 C 34,36 34.5,34.5 33,33.5 C 32.5,31 32.5,31.5 33.5,30 C 34.5,28 36,28 36,26 C 27.5,24.5 17.5,24.5 9,26 z \" style=\"stroke-linecap:butt;\"/>    <path d=\"M 11.5,30 C 15,29 30,29 33.5,30\" style=\"fill:none;\"/>    <path d=\"M 12,33.5 C 18,32.5 27,32.5 33,33.5\" style=\"fill:none;\"/>  </g></svg>';
		case 'b_p':
...
var _darrensiegel$elm_chess_client$View_Asset$getSvgTag = F2(
	function (prefix, f) {
		return _darrensiegel$elm_chess_client$View_Asset$svgTag(
			A2(
				_elm_lang$core$Basics_ops['++'],
				prefix,
				_elm_lang$core$String$fromChar(
					_darrensiegel$elm_chess_client$Depo_SAN$fromRole(f))));
	});
var _darrensiegel$elm_chess_client$View_Asset$getSvg = function (_p1) {
	...
	var _p3 = _p2.color;
	if (_p3.ctor === 'Black') {
		return A2(_darrensiegel$elm_chess_client$View_Asset$getSvgTag, 'b_', _p4);
	} else {
		return A2(_darrensiegel$elm_chess_client$View_Asset$getSvgTag, 'w_', _p4);
	}
};
...
var _darrensiegel$elm_chess_client$View_Main$r_square = function (sq) {
	var attrs = sq.valid ? {
		...
		_0: _elm_lang$html$Html_Attributes$classList(
			{
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'active', _1: sq.active},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'valid', _1: sq.valid},
					_1: {
						ctor: '::',
...
var _darrensiegel$elm_chess_client$View_Main$r_dragSvg = function (_p0) {
	var _p1 = _p0;
	var _p3 = _p1.piece;
	var o = _darrensiegel$elm_chess_client$Data_Cast$toBoardPosition(_p1.focus);
	var y = _p3.drag.y;
	var x = _p3.drag.x;
		...
		return A3(
			...
			'piece',
			{
				...
				_0: _elm_lang$html$Html_Attributes$style(
					{
						ctor: '::',
						_0: A2(_darrensiegel$elm_chess_client$Depo_Lib_ops['=>'], 'position', 'absolute'),
						_1: {
							ctor: '::',
							_0: A2(
								_darrensiegel$elm_chess_client$Depo_Lib_ops['=>'],
								'top',
								_darrensiegel$elm_chess_client$Depo_Lib$px(dest.y)),
							_1: {
								ctor: '::',
								_0: A2(
									_darrensiegel$elm_chess_client$Depo_Lib_ops['=>'],
									'left',
									_darrensiegel$elm_chess_client$Depo_Lib$px(dest.x)),
								_1: {ctor: '[]'}
							}
						}
					}),
...
var _darrensiegel$elm_chess_client$View_Main$r_svg = function (_p4) {
	var _p5 = _p4;
	var _p6 = _p5.drag;
	var x = _p6.x;
	var y = _p6.y;
		...
		_0: _elm_lang$html$Html_Attributes$style(
			{
				...
				_0: A2(
					_darrensiegel$elm_chess_client$Depo_Lib_ops['=>'],
					'top',
					_darrensiegel$elm_chess_client$Depo_Lib$px(y)),
				_1: {
					ctor: '::',
					_0: A2(
						_darrensiegel$elm_chess_client$Depo_Lib_ops['=>'],
						'left',
						_darrensiegel$elm_chess_client$Depo_Lib$px(x)),
					_1: {ctor: '[]'}
				}
			}),
		_1: {ctor: '[]'}
	};
	var _p7 = _rnons$elm_svg_parser$SvgParser$parse(
		_darrensiegel$elm_chess_client$View_Asset$getSvg(_p5));
	if (_p7.ctor === 'Err') {
...
var _darrensiegel$elm_chess_client$View_Main$r_piece = function (s) {
	...
	if (_p8.ctor === 'Just') {
		return _elm_lang$core$Maybe$Just(
			_darrensiegel$elm_chess_client$View_Main$r_svg(_p8._0));
	} else {
		return _elm_lang$core$Maybe$Nothing;
	}
};
...
var _darrensiegel$elm_chess_client$View_Main$map_board = F2(
	function (f, _p9) {
		...
		return {
			ctor: '_Tuple2',
			_0: A2(_darrensiegel$elm_chess_client$View_Main$filter_rank, f, _p10._0),
			_1: A2(_darrensiegel$elm_chess_client$View_Main$filter_rank, f, _p10._1)
		};
	});
	...
	var sortSqs = A2(
		...
		F2(
			function (sq, mem) {
				var _p11 = sq.piece;
				if (_p11.ctor === 'Just') {
					var _p12 = _p11._0.color;
					if (_p12.ctor === 'Black') {
						return {
							ctor: '_Tuple2',
							_0: _darrensiegel$elm_chess_client$Depo_Lib$fst(mem),
							_1: A2(
								_elm_lang$core$Basics_ops['++'],
								_darrensiegel$elm_chess_client$Depo_Lib$snd(mem),
								{
									ctor: '::',
									_0: sq,
									_1: {ctor: '[]'}
						...
						return {
							...
							_0: A2(
								_elm_lang$core$Basics_ops['++'],
								_darrensiegel$elm_chess_client$Depo_Lib$fst(mem),
								{
									ctor: '::',
									_0: sq,
									_1: {ctor: '[]'}
								}),
							_1: _darrensiegel$elm_chess_client$Depo_Lib$snd(mem)
						};
					}
				} else {
					return mem;
	...
	return A3(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				_darrensiegel$elm_chess_client$Depo_Lib$fst(pieces)),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('black'),
						_1: {ctor: '[]'}
					},
					_darrensiegel$elm_chess_client$Depo_Lib$snd(pieces)),
				_1: {ctor: '[]'}
			}
		});
};
var _darrensiegel$elm_chess_client$View_Main$r_player = function (_p13) {
	var _p14 = _p13;
	var mv_piece = function () {
		var _p15 = _p14.action;
		if (_p15.ctor === 'Moving') {
			return {
				ctor: '_Tuple2',
				_0: {
					...
					_0: _elm_lang$html$Html_Attributes$classList(
						{
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'visible', _1: true},
							_1: {
								ctor: '::',
								_0: {
									ctor: '_Tuple2',
									_0: _elm_lang$core$Basics$toString(_p14.color),
									_1: true
								},
								_1: {ctor: '[]'}
							}
...
var _darrensiegel$elm_chess_client$View_Main$onMouseDown = A2(
	_elm_lang$html$Html_Events$on,
	'mousedown',
	A2(_elm_lang$core$Json_Decode$map, _darrensiegel$elm_chess_client$Data_Type$Click, _elm_lang$mouse$Mouse$position));
var _darrensiegel$elm_chess_client$View_Main$r_game = function (_p16) {
	var _p17 = _p16;
	var _p19 = _p17.players;
	var _p18 = _p17.chess;
	return A3(
		_elm_lang$html$Html$node,
		'chess',
		{
			ctor: '::',
			_0: _darrensiegel$elm_chess_client$View_Main$onMouseDown,
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class(
					_elm_lang$core$String$toLower(
						_elm_lang$core$Basics$toString(
							_darrensiegel$elm_chess_client$Depo_Lib$fst(_p19).color))),
				_1: {ctor: '[]'}
			}
		},
		{
			ctor: '::',
			_0: _darrensiegel$elm_chess_client$View_Main$r_player(
				_darrensiegel$elm_chess_client$Depo_Lib$fst(_p19)),
			_1: {
				ctor: '::',
				_0: _darrensiegel$elm_chess_client$View_Main$r_pieces(_p18.board),
				_1: {
					ctor: '::',
					_0: _darrensiegel$elm_chess_client$View_Main$r_board(_p18.board),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _darrensiegel$elm_chess_client$View_Main$render = function (_p20) {
	var _p21 = _p20;
	var _p24 = _p21.ui;
	...
	return A4(
		...
		_darrensiegel$elm_chess_client$Data_Type$GUI,
		_p24.mdl,
		{
			ctor: '::',
		...
		},
		{
			...
			main: {
				ctor: '::',
				_0: _darrensiegel$elm_chess_client$View_Main$r_game(_p21),
				_1: {
					ctor: '::',
					_0: A2(
						_debois$elm_mdl$Material_Options$div,
						{
							ctor: '::',
							_0: _debois$elm_mdl$Material_Options$cs('hud'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(_p24.turn),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _debois$elm_mdl$Material_Options$cs('player'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(blackPlayer.name),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _debois$elm_mdl$Material_Options$cs('history'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: A2(
												...
												{
													ctor: '::',
													_0: _debois$elm_mdl$Material_Options$cs('moves'),
													_1: {ctor: '[]'}
												},
												A2(
													_elm_lang$core$List$map,
													...
													_darrensiegel$elm_chess_client$Model_History$formatHistory(_p22.history))),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(whitePlayer.name),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
...
var _darrensiegel$elm_chess_client$Chess$startGame = function () {
	var newBoard = _darrensiegel$elm_chess_client$Depo_FEN$fromFEN(_darrensiegel$elm_chess_client$Depo_FEN$openingBoard);
	var start = _darrensiegel$elm_chess_client$Data_Pure$newGame.chess;
	return _elm_lang$core$Native_Utils.update(
		_darrensiegel$elm_chess_client$Data_Pure$newGame,
		{
			chess: _elm_lang$core$Native_Utils.update(
				start,
				{board: newBoard})
		});
}();
var _darrensiegel$elm_chess_client$Chess$main = _elm_lang$html$Html$program(
	{
		init: A2(_elm_lang$core$Platform_Cmd_ops['!'], _darrensiegel$elm_chess_client$Chess$startGame, _darrensiegel$elm_chess_client$Data_Pure$startCommands),
		view: _darrensiegel$elm_chess_client$View_Main$render,
		update: _darrensiegel$elm_chess_client$State_Game$update,
		subscriptions: _darrensiegel$elm_chess_client$State_Game$subscribe
	})();

var Elm = {};
Elm['Chess'] = Elm['Chess'] || {};
if (typeof _darrensiegel$elm_chess_client$Chess$main !== 'undefined') {
    _darrensiegel$elm_chess_client$Chess$main(Elm['Chess'], 'Chess', undefined);
}
